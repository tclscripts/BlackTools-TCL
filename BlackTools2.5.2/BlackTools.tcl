...
set black(default_away) "BlackTools 2.5.2 - > http://tclscripts.net"
...
set black(banmethod_memory_time) "1m"
...
putlog "\002$black(name) v$black(vers)\002 coded by $black(author): Loaded."
putlog "\002\[BT\]\002 ($black(site)) *** The Future is Here ***"
