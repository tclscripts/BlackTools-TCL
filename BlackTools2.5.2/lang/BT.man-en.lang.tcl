...
set black(say.en.man.158) "\[MAN\] \002%char%addhost\002 <handle> <mask> ; \002%botnick% addhost\002 <handle> <mask> ; \002(PRIVMSG) addhost\002 <#chan> <handle> <mask>"
...
set black(say.en.man.161) "\[MAN\] \002%char%delhost\002 <handle> <mask> ; \002%botnick% delhost\002 <handle> <mask> ; \002(PRIVMSG) delhost\002 <#chan> <handle> <mask>"
...
set black(say.en.man.177) "\[MAN\] \002AntiPub\002 bans users who advertise using *#*, *http://* or *www.* (support wildcards)."
...
set black(say.en.man.180) "\[MAN\] \002%char%antipub\002 add \[#chan\] <link|#chan> ; \002%char%antipub\002 \[#chan\] list"
set black(say.en.man.180_1) "\[MAN\] \002%char%antipub add\002 \[#chan\] <+word> (add exceptions) ; \002%char%antipub\002 del \[#chan\] <no. list> (remove antipub from list)"
...
set black(say.en.man.193) "\[MAN\] \002AntiBadWord\002 bans users who use *bad/forbidden* words/phrases (support wildcards)."
...
set black(say.en.man.196) "\[MAN\] \002%char%badword add\002 \[#chan\] <word|phrase> ; \002%char%badword \[#chan\] list\002 ; \002%char%badword del \[#chan\]\002 <no. list>"
set black(say.en.man.197) "\[MAN\] \002%char%badword add\002 \[#chan\] <+word> (add exceptions) ; \002%char%badword add\002 \[#chan\] <word:no. method> (see \002%char%man banmethod\002)"
...
set black(say.en.man.204) "\[MAN\] \002AntiBadQuitPart\002 bans users who use *bad/forbidden* words when parting a channel (support wildcards)."
...
set black(say.en.man.207) "\[MAN\] \002%char%badquitpart add\002 \[#chan\] <word> ; \002%char%badquitpart\002 \[#chan\] list"
set black(say.en.man.208) "\[MAN\] \002%char%badquitpart add\002 \[#chan\] <+word> (add exceptions) ; \002%char%badquitpart del\002 \[#chan\] <no. list> (remove badquitpart from list)"
...
set black(say.en.man.246) "\[MAN\] \002BadNick\002 bans users who are using NICKNAMEs which contains *bad/forbidden* words/characters (support wildcards)."
...
set black(say.en.man.249) "\[MAN\] \002%char%badnick add\002 \[#chan\] <word> ; \002%char%badnick \[#chan\] list\002"
set black(say.en.man.250) "\[MAN\] \002%char%badnick add\002 \[#chan\] <+word> (add exceptions) ; \002%char%badnick del\002 \[#chan\] <no. list> (remove badnick from list)"
...
set black(say.en.man.252) "\[MAN\] \002BadRealname\002 bans users who are using REALNAMEs which contains *bad/forbidden* words/characters (support wildcards)."
...
set black(say.en.man.255) "\[MAN\] \002%char%badrealname add\002 \[#chan\] <word> ; \002%char%badrealname \[#chan\] list\002"
set black(say.en.man.256) "\[MAN\] \002%char%badrealname add\002 \[#chan\] <+word> (add exceptions) ; \002%char%badrealname del\002 \[#chan\] <no. list> (remove badrealname from list)"
...
set black(say.en.man.274) "\[MAN\] \002BadIdent\002 bans users who are using IDENTs which contains *bad/forbidden* words/characters (support wildcards)."
...
set black(say.en.man.277) "\[MAN\] \002%char%badident add\002 \[#chan\] <word> ; \002%char%badident \[#chan\] list\002"
set black(say.en.man.278) "\[MAN\] \002%char%badident add\002 \[#chan\] <+word> (add exceptions) ; \002%char%badident del\002 \[#chan\] <no. list> (remove badident from list)"
...
set black(say.en.man.410) "\[MAN\] \002BadChan\002 forbids people who are co-channeling *bad/forbidden* channels to stay on a specified channel (support wildcards)."
...
set black(say.en.man.417) "\[MAN\] \002Anunt/Advert\002 displays announcements/ads on a channel over a certain amount of time and depending on the channel activity."
...
set black(say.en.man.438_1) "\[MAN\] USAGE SYNTAX: \002%char%seen\002 <nick|mask>"
...
set black(say.en.man.441) "\[MAN\] \002Greet\002 adds a welcome message and send it to all users who joins that channel (see also \002%char%man infoline\002)."
...
set black(say.en.man.446) "\[MAN\] ** Note: To add more than 1 sentence in an greet use \002%char%greet add <message1>~<message2>\002.. and eggdrop will show the greet as 2 different senteces. **"
...
set black(say.en.man.787) "\[MAN\] \002%char%badhost add\002 \[#chan\] <ip|mask> ; \002%char%badhost \[#chan\] list\002"
set black(say.en.man.787_1) "\[MAN\] \002%char%badhost add\002 \[#chan\] <+word> (add exceptions) ; \002%char%badhost del\002 \[#chan\] <no. list> (remove badhost from list)"
...
set black(say.en.man.1113_1) "\[MAN\] \002 %char%set away\002 OFF ; \002%botnick% set away\002 OFF ; \002(PRIVMSG) set away\002 OFF (disable away)"
...
set black(say.en.man.showtip) { 
 ...
 "\[TIP\] Check our forum at\037 http://tclscripts.net\037 for the latest updates & informations."
