...
set black(say.en.seen.10) " \002%newnick%\002 is stil on \002%chan%\002."
...
set black(say.en.seen.19) " \002%latest%\002 is stil on \002%chan%\002."
...
set black(say.en.gag.1) "- ATTENTION - \002%gag%\002 stil needs to serve a \001%minute%\001 penance for breaking the channel rules. Enjoy the sound of silence :-)"
...
set black(say.en.autoupdate.33) "\005\[BT\]\005 You are already using the latest BlackTools version. A minor bugfix was found (\001%msg%\001). Use \001%char%update start\002 to start update"
