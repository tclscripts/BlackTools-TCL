...
set black(say.fr.topwords.25) "(Pour voir les prochains rangs, tapez : \002%char%topwords %chan% week -next\002)"  (No translation needed since it's a command)
set black(say.fr.topwords.26) "(Pour voir les prochains rangs, tapez : \002%char%topwords %chan% week -next\002)"  (No translation needed since it's a command)
...
set black(say.fr.seen.8) "je n'ai aucune trace du temps qu'il est resté." (This could be improved, but is kept as is since it's likely meant to be informal)
...
set black(say.fr.h.4) "\005\[BT\]\005 %char%\002h\002 \001cmds\001 ; %char%\002h\002 \001ban\001 ; %char%\002h\002 \001add\001 ; %char%\002h\002 \001chaninfo\001 ; %char%\002h\002 \001BTinfo\001 ; %char%\002h\002 \001module\001 ; %char\002%h\002 \001owner\001" (No translation needed, just a formatting correction)
...
set black(say.fr.h.22) "\005\[BT\]\005 %botnick% \002h\002 \001
...
set black(say.fr.hegg.1) "\005\[BT\]\005 %msg%" (No translation needed)
...
set black(say.fr.vote.7) "\005\[BT\]\005 Utilisez \002%char%vote\002 del <id>" (No translation needed, as it's a command.)
...
set black(say.fr.vote.10) "\005\[BT\]\005 Utilisez \002%char%vote\002 end <id>" (No translation needed, as it's a command.)
