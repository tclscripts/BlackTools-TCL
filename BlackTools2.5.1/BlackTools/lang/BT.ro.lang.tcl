...
set black(say.ro.gl.invalidlevel) "\005\[BT\]\005 Nu poti aplica ban pe nivelul specificat (poti folosi \001%msg%\001)"
...
set black(say.ro.antipub.4) "\005\[BT\]\005 Nu exista \002exceptia\002 antipub cu nr.\001%msg.1%\001 pentru \002%chan%\002."
set black(say.ro.antipub.5) "\005\[BT\]\005 Am sters \002exceptia\002 antipub cu numarul \001%msg.1%\0021 pentru \002%chan%\002."
set black(say.ro.antipub.6) "\005\[BT\]\005 Am adaugat in lista de exceptii \001%msg.8%\001 cu nr.\002%msg.1%\002 pentru \002%chan%\002."
set black(say.ro.antipub.7) "\005\[BT\]\005 Lista de \002exceptii\002 antipub pentru \001%chan%\001 este:"
set black(say.ro.antipub.8) "\005\[BT\]\005 Pentru afisarea urmatoarelor exceptii foloseste: \001%char%antipub list -next\001 (\002%counter%\002 exceptii ramase)"
set black(say.ro.antipub.9) "\005\[BT\]\005 Pentru afisarea urmatoarelor exceptii foloseste: \001%char%antipub %chan% list -next\001 (\002%counter%\002 exceptii ramase)"
...
set black(say.ro.badword.4) "\005\[BT\]\005 Nu exista \002badword\002 cu nr.\001%msg.1%\001 pentru \002%chan%\002."
set black(say.ro.badword.5) "\005\[BT\]\005 Am sters \002badword\002 cu numarul \001%msg.1%\001 pentru \002%chan%\002."
...
set black(say.ro.antibadword.7) "\005\[BT\]\005 Lista de \002BadWords\002 pentru \002%chan%\002 este:"
set black(say.ro.antibadword.8) "\005\[BT\]\005 Pentru afisarea urmatoarelor \002BadWords\002 foloseste: \001%char%badword list -next\001 (\002%counter%\002 badwords ramase)"
set black(say.ro.antibadword.9) "\005\[BT\]\005 Pentru afisarea urmatoarelor \002BadWords\002 foloseste: \001%char%badword %chan% list -next\001 (\002%counter%\002 badwords ramase)"
...
set black(say.ro.badquitpart.4) "\005\[BT\]\005 Nu exista \002exceptia\002 badquitpart cu nr.\001%msg.1%\001 pentru \002%chan%\002."
set black(say.ro.badquitpart.5) "\005\[BT\]\005 Am sters \002exceptia\002 badquitpart cu numarul \001%msg.1%\001 pentru \002%chan%\002."
set black(say.ro.badquitpart.6) "\005\[BT\]\005 Am adaugat in lista de exceptii \001%msg.8%\001 cu nr.\002%msg.1%\002 pentru \002%chan%\002."
set black(say.ro.antibadquitpart.7) "\005\[BT\]\005 Lista de \002exceptii\002 badquitpart pentru %chan% este:"
set black(say.ro.antibadquitpart.8) "\005\[BT\]\005 Pentru afisarea urmatoarelor exceptii foloseste: \001%char%badquitpart list -next\001 (\002%counter%\002 exceptii ramase)"
set black(say.ro.antibadquitpart.9) "\005\[BT\]\005 Pentru afisarea urmatoarelor exceptii foloseste: \001%char%badquitpart %chan% list -next\001 (\002%counter%\002 exceptii ramase)"
...
set black(say.ro.badnick.8) "\005\[BT\]\005 Pentru afisarea urmatoarelor \002BadNicks\002 foloseste: \001%char%badnick list -next\001 (\002%counter%\002 badnick ramase)"
set black(say.ro.badnick.9) "\005\[BT\]\005 Pentru afisarea urmatoarelor \002BadNicks\002 foloseste: \001%char%badnick %chan% list -next\001 (\002%counter%\002 badnick ramase)"
...
set black(say.ro.antijoinflood.1) "Atentie! Am observat un join flood pe \002%chan%\00. Va rog verificati!"
...
set black(say.ro.securemode.1) "\002ATENTIE:\002 ai incercat sa intri pe \001%chan%\001, dar canalul este in \002lockdown\002 (\002+mD\002). Pentru a ti se permite sa intri tasteaza: \001/msg %botnick% check %chan% %msg.1%\001 sa dovedesti ca nu esti un robot. Daca te incurci nu se va intampla nimic."
...
set black(say.ro.voiceme.3) "\005\[BT\]\005 Bravo! Ai primit \001voice(+v)\001 pe \002%chan%\002. Chat placut! :)"
set black(say.ro.voiceme.4) "\005\[BT\]\005 Ai deja \001voice(+v)\001 pe \002%chan%\002."
set black(say.ro.voiceme.5) "\005\[BT\]\005 Pentru a dovedi ca nu esti un robot tasteaza: \002/msg %botnick% voiceme %chan% %msg%\002"
set black(say.ro.voiceme.6) "\005\[BT\]\005 Canalul este \002moderat(+m)\002. Pentru a putea discuta pe \002%chan%\002 trebuie sa folositi: \001/msg %botnick% voiceme %chan%\001. Enjoy!"

################################## BanStats #####################################

set black(say.ro.topbans.1) "\002BanStats\002 Total: \001%msg%\001"
set black(say.ro.topbans.2) "\002BanStats\002 de Astazi: \001%msg%\001"
...
set black(say.ro.topwords.2) "\002TopWords\002 de Astazi: \001%msg%\001"
...
set black(say.ro.reportchan) "\005\[BT\]\005 Am adaugat ban pe \002%chan%\002 pe hostul \001%banmask%\001 cu motivul: \002%reason%\002. Acesta va expira in: \001%bantime%\001."
set black(say.ro.reportchan.1) "\005\[BT\]\005 \[\002%nick%\002\] a adaugat ban pe \002%chan%\002 pe hostul \001%banmask%\001 cu motivul: %reason%. Acesta va expira in: \001%bantime%\001."
...
set black(say.ro.reportchan.2) "\005\[BT\]\005 \[\002%nick%\002\] a adaugat Gag pe \002%chan%\002 pe hostul \001%banmask%\001 cu motivul: \002%reason%\002. Acesta va expira in: \001%bantime%\001."
...
set black(say.ro.clonescan.10) "\005\[BT\]\005 Am gasit \001%msg.1%\001 clone pe \002%chan%\002 de la host-ul \002%msg.2%\002. Acestea sunt: \001%msg.7%\001"
...
set black(say.ro.badchan.40) "\002ATENTIE!\002 Ai fost gasit pe canale interzise. Ai la dispozitie 30 de secunde sa dai \001/part\001 la: \002%badchans%\002, in caz contrar vei primi ban. Multumesc!"
...
set black(say.ro.quote.3) "\005\[BT\]\005 #%msg.1% :: \002Creat in\002: \001%msg.2%\001"
set black(say.ro.quote.4) "\005\[BT\]\005 %msg.1% :: \001%msg.2%\001 :: \002Creat in\002: \001%msg.3%\001"
...
set black(say.ro.notes.11) "\005\[BT\]\005 Ai \001%msg.1%\001 note-uri noi din \002%msg.2%\002 note-uri total. Numerele sunt: \002%msg.7%\002"
set black(say.ro.notes.12) "\005\[BT\]\005 Ai \001%msg.1%\001 note-uri noi din \002%msg.2%\002 note-uri total."
set black(say.ro.notesinbox.13) "\005\[BT\]\005 Pentru a citi note-urile foloseste: \002%char%note read <numar>\002"
set black(say.ro.notesinbox.15) "\005\[BT\]\005 Pentru a afisa urmatoarele \002Notes\002 foloseste: \001%char%note inbox -next\001 (\002%counter%\002 note-uri ramase)"
set black(say.ro.notesinbox.16) "\005\[BT\]\005 Pentru a afisa urmatoarele \002Notes\002 foloseste: \001%char%note %chan% inbox -next\001 (\002%counter%\002 note-uri ramase)"
...
set black(say.ro.noteslist.15) "\005\[BT\]\005 Pentru a afisa urmatoarele \002Notes\002 foloseste: \001%char%note list -next\001 (\002%counter%\002 note-uri ramase)"
set black(say.ro.noteslist.16) "\005\[BT\]\005 Pentru a afisa urmatoarele \002Notes\002 foloseste: \001%char%note %chan% list -next\001 (\002%counter%\002 note-uri ramase)"
set black(say.ro.noteslist.13) "\005\[BT\]\005 Pentru a citi Note-ul intreg foloseste: \002%char%note read <numar>\002"
set black(say.ro.notes.15) "\005\[BT\]\005 Am sters toate \002note-rile\002 din INBOX."
set black(say.ro.notes.16) "\005\[BT\]\005 Pentru a citi un note foloseste: \002%char%note read <numar>\002"
...
set black(say.ro.report.2) "\005\[BT\]\005 \[REPORT\] Nick: \002%msg.1%\002 ; Raportat de: \002%msg.2%\002 ; Motiv: \001%msg.8%\001"
set black(say.ro.report.3) "\005\[BT\]\005 \[REPORT\] Nick: \001%msg.1%\001 ; Raportat de: \002%msg.2%\002"
...
set black(say.ro.troll.6) "\005\[BT\]\005 Trolii curenti (cei fara 7 ani de acasa) sunt: \001%msg%\001"
...
set black(say.ro.gag.1) "\005\[BT\]\005 - ATENTIE - \002%gag%\002 mai are de ispasit o perioada de \001%minute%\001 de Gag. Bucura-te de sunetul linistii :-)"
...
set black(say.ro.gag.5) "\005\[BT\]\005 - ATENTIE - a expirat gag-ul pentru \002%nick%\002, acum poti tasta pe \002%chan%\002. Data viitoare sa fii mai atent :-)"
set black(say.ro.gag.6) "N/A"
set black(say.ro.gag.7) "\005\[BT\]\005 Perioada maxima de Gag pentru nivelul tau este de \0027d\002 (\001 20160 minute\001 )"
set black(say.ro.gag.10) "\005\[BT\]\005 Nu mai poti scrie pe \002%chan%\002 pentru \001%time%\001."
set black(say.ro.gag.11) "\005\[BT\]\005 - ATENTIE - \002%gagger%\002 nu o sa mai poata tasta pe \002%chan%\002 pentru \001%time%\001."
...
set black(say.ro.ungag.8) "\005\[BT\]\005 - ATENTIE - %gagger% acum poate tasta pe %chan%.."
...
set black(say.ro.sb.3) "\005\[BT\]\005 \[ID: \001%msg.1%\001\] ; \[CANAL\] * ; \002%msg.2%\002 ; Adaugat de: \002%msg.3%\002 ; Data: \002%msg.4%\002 ; Expira: %msg.12% \002%msg.13%\002 \002%msg.15%\002 ; Motiv: %msg.16%"
set black(say.ro.sb.4) "\005\[BT\]\005 \[ID: \001%msg.1%\001\] ; \[CANAL\] \002%chan%\002 ; \002%msg.2%\002 ; Adaugat de: \002%msg.3%\002 ; Data: \002%msg.4%\002 ; Expira: %msg.12% \002%msg.13%\002 \002%msg.15%\002 ; Motiv: %msg.16%"
...
set black(say.ro.sb.9) "\005\[BT\]\005 \[ID: \001%msg.1%\001\] ; \[CANAL\] \002%chan%\002 ; \002%msg.2%\002 ; Adaugat de: \002%msg.3%\002 ; Data: \002%msg.4%\002 ; Expira: %msg.12% ; Motiv: %msg.11%"
set black(say.ro.sb.10) "\005\[BT\]\005 \[ID: \001%msg.1%\001\] ; \[CANAL\] * ; \002%msg.2%\002 ; Adaugat de: \002%msg.3%\002 ; Data: \002%msg.4%\002 ; Expira: %msg.12% ; Motiv: %msg.11%"
...
set black(say.ro.status.1) "\005\[BT\]\005 Versiune script: \001%msg.1% %msg.2%\001. Versiune eggdrop: \002%msg.3%\002."
...
set black(say.ro.ignore.4) "\005\[BT\]\005 Host:\001%msg.1%\001 Adaugat de: \002%msg.2%\002 Motiv: \002%msg.6%\002 Data expirare: \001%msg.3%\001"
...
set black(say.ro.info.2) "\005\[BT\]\005 \[CANAL\] \002%msg.1%\002 -- AUTOMODE: \002%msg.2%\002 -- STATISTICI: \001%char%activ %msg.3%\001"
...
set black(say.ro.cmdsop) "o \[#canal\] \[nick\] ; v \[#canal\] \[nick\] ; ho \[#canal\] \[nick\] ; man <comanda> ; version ; mode \[#canal\] <+/-mod> ; cycle \[#canal\] \[motiv\] ; i \[#canal\] <nick> ; activ \[#canal\] <nick> ; t \[#canal\] <text> ; myset <optiune> \[descriere\] \[reset\]/\[show\] ; h \[#canal\] \[categorie\] ; r \[#canal\] ; omsg \[#canal / all\] <text>"
set black(say.ro.cmdadmin) "o \[#canal\] \[nick\] ; v \[#canal\] \[nick\] ; ho \[#canal\] \[nick\] ; man <comanda> ; version ; mode \[#canal\] <+/-mod> ; cycle \[#canal\] \[motiv\] ; say \[#canal\] <text> ; act \[#canal\] <text> ; i \[#canal\] <nick> ; activ \[#canal\] <nick> ; t \[#canal\] <text> ; myset <optiune> \[descriere\] \[reset\]/\[show\] ; h \[#canal\] \[categorie\] ; r \[#canal\] ; omsg \[#canal / all\] <text>"
set black(say.ro.cmdmanager) "o \[#canal\] \[nick\] ; v \[#canal\] \[nick\] ; ho \[#canal\] \[nick\] ; man <comanda> ; version ; mode \[#canal\] <+/-mod> ; cycle \[#canal\] \[motiv\]/\[timp\] ; say \[#canal\] <text> ; act \[#canal\] <text> ; i \[#canal\] <nick> ; activ \[#canal\] <nick> ; t \[#canal\] <text> ; myset <optiune> \[descriere\] \[reset\]/\[show\] ; h \[#canal\] \[categorie\] ; r \[#canal\] ; omsg \[#canal / all\] <text>"
set black(say.ro.cmdbossowner) "o \[#canal\] \[nick\] ; v \[#canal\] \[nick\] ; ho \[#canal\] \[nick\] ; man <comanda> ; version ; mode \[#canal\] <+/-mod> ; cycle \[#canal\] \[motiv\]/\[timp\] ; say \[#canal\] <text> ; act \[#canal\] <text> ; broadcast <text> ; i \[#canal\] <nick> ; activ \[#canal\] <nick> ; t \[#canal\] <text> ; myset <optiune> \[descriere\] \[reset\]/\[show\] ; h \[#canal\] \[categorie\] ; r \[#canal\] ; msg <nick> <text> ; omsg \[#canal / all\] <text>"
set black(say.ro.cmdmaster) "o \[#canal\] \[nick\] ; v \[#canal\] \[nick\] ; ho \[#canal\] \[nick\] ; man <comanda> ; version ; mode \[#canal\] <+/-mod> ; cycle \[#canal\] \[motiv\]/\[timp\] ; say \[#canal\] <text> ; act \[#canal\] <text> ; i \[#canal\] <nick> ; activ \[#canal\] <nick> ; t \[#canal\] <text> ; myset <optiune> \[descriere\] \[reset\]/\[show\] ; h \[#canal\] \[categorie\] ; r \[#canal\] ; msg <nick> <text> ; omsg \[#canal / all\] <text>"

set black(say.ro.banvoice) "k \[#canal\] <nick> \[motiv\] ; w \[#canal\] <nick>"
set black(say.ro.banop) "b \[#canal\] <nick>/<host> \[-nivel\] \[timp\] \[motiv\] ; dr \[#canal\] <nick>/<host> ; bot \[#canal\] <nick>/<host> ; n \[#canal\] <nick> ; id \[#canal\] <nick> ; spam \[#canal\] <nick>/<host> ; bw \[#canal\] <nick>/<host> ; vr \[#canal\] <nick>/<host> ; gag \[#canal\] <nick> <timp> <motiv> ; ungag \[#canal\] <nick>/<host> ; troll \[#canal\] <nick> ; mb \[#canal\] <nick> \[reason\] ; ub \[#canal\] <nick>/<host>/<id> ; sb \[#canal\] <nick>/<host>/<id> ; banlist \[#canal\] <all>/<user>/<other> ; banstats \[total\] ; k \[#canal\] <nick> \[motiv\] ; w \[#canal\] <nick>"
...
set black(say.ro.banmanager) "b \[#canal\] <nick>/<host> \[-nivel\] \[timp\] \[motiv\] ; black \[#canal\] <nick>/<host> \[motiv\] ; stick \[#canal\] <nick>/<host> \[timp\] \[motiv\] ; dr \[#canal\] <nick>/<host> ; bot \[#canal\] <nick>/<host> ; n \[#canal\] <nick> ; id \[#canal\] <nick> ; spam \[#canal\] <nick>/<host> ; bw \[#canal\] <nick>/<host> ; vr \[#canal\] <nick>/<host> ; gag \[#canal\] <nick> <timp> <motiv> ; ungag \[#canal\] <nick>/<host> ; troll \[#canal\] <nick> ; mb \[#canal\] <nick> \[reason\] ; ub \[#canal\] <nick>/<host>/<id> ; sb \[#canal\] <nick>/<host>/<sb> ; banlist \[#canal\] <all>/<user>/<other> ; banstats \[total\] \[reset\] ; k \[#canal\] <nick> \[motiv\] ; w \[#canal\] <nick>"
set black(say.ro.banbossowner) "b \[#canal\] <nick>/<host> \[-nivel\] \[timp\] \[global\] \[link\] \[motiv\] ; black \[#canal\] <nick>/<host> \[motiv\] ; stick \[#canal\] <nick>/<host> \[timp\] \[motiv\] ; dr \[#canal\] <nick>/<host> ; bot \[#canal\] <nick>/<host> ; n \[#canal\] <nick> ; id \[#canal\] <nick> ; spam \[#canal\] <nick>/<host> ; bw \[#canal\] <nick>/<host>; vr \[#canal\] <nick>/<host> ; gag \[#canal\] <nick> <timp> <motiv> ; ungag \[#canal\] <nick>/<host> ; troll \[#canal\] <nick> ; mb \[#canal\] <nick> \[reason\] ; ub \[#canal\] <nick>/<host>/<id> \[global\] \[link\] ; sb \[#canal\] <nick>/<host>/<id> \[global\] ; banlist \[#canal\] <all>/<user>/<other>/<global> ; banstats \[total\] \[reset\] ; k \[#canal\] <nick> \[motiv\] ; w \[#canal\] <nick>"
...
set black(say.ro.greeting.5) "\005\[BT\]\005 Pentru o \002lista completa\002 a comenzilor disponibile foloseste: \001%char%h\001 ; \002%botnick% h\002 ; \001(PRIVMSG) h\001"
...
set black(say.ro.egg.2) "\005\[BT\]\005 %msg.1% este setat la: \"\002%msg.8%\002\". Pentru modificare, foloseste: \001%char%egg %msg.1% <valoare noua>\001"
set black(say.ro.egg.3) "\005\[BT\]\005 Am modificat setarea \"\002%msg.1%\002\". In caz ca modificarea nu e vizibila executati \"\001%botnick% restart\001\" sau verificati daca valoarea e valida."
...
set black(say.ro.egg.5) "\005\[BT\]\005 Nu poti seta \001%msg.1%\001 cu valoarea \002%msg.2%\002, te rog citeste manualul folosind \001%char%man egg\001."
set black(say.ro.egg.6) "\005\[BT\]\005 Nu poti seta \001%msg.1%\001 cu valoarea \002%msg.2%\002, te rog citeste manualul folosind \001%char%man %msg.3%\001."
set black(say.ro.egg.7) "\005\[BT\]\005 \001%msg.1%\001 este setat la: \002%msg.8%\002. Pentru modificare, foloseste: \001egg %msg.1% <valoare noua>\001"
set black(say.ro.egg.8) "\005\[BT\]\005 \001%msg.1%\001 este setat la: \002%msg.8%\002. Pentru modificare, foloseste: \001%botnick% egg %msg.1% <valoare noua>\001"
...
set black(say.ro.hello.1) "*** TAADAAA! *** Ai access de \002%msg%\002 la comenzile mele."
set black(say.ro.hello.2) "\005\[BT\]\005 Salut \001%msg.1%\001, Sunt \002%botnick%\002, un eggdrop ce ruleaza \001%msg.2%\001 %msg.3%."
set black(say.ro.hello.3) "\005\[BT\]\005 De acum incolo o sa te recunosc dupa host-ul '\001%msg.1%\001'. Foloseste \002%char%h\002 ; \002%botnick%\002 h, una din aceste metode, pentru a incepe utilizarea acestui eggdrop."
set black(say.ro.hello.4) "\005\[BT\]\005 Te rog seteaza-ti o parola, folosind comanda: \001/msg \002%botnick% pass\002 <parola ta>\001"
