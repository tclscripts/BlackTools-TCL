...
set black(say.en.man.444) "\[MAN\] \002%char%greet\002 \[#chan\] set <text>\002 ; \002%botnick% greet\002 \[#chan\] set <text> ; \002(PRIVMSG) greet\002 \[#chan\] set <text>"
...
set black(say.en.man.450) "\[MAN\] \002%char%leave\002 \[#chan\] set <text>\002 ; \002%botnick% leave\002 \[#chan\] set <text> ; \002(PRIVMSG) leave\002 \[#chan\] set <text>"
...
set black(say.en.man.846) "\[MAN\] \002VoiceOnMsg\002 is a module that voices users who have said a certain number of lines on a channel (active chatters). Also, users with access are excluded."
