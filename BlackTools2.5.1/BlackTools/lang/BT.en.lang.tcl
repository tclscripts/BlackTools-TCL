...
set black(say.en.activ.1) "BanStats: (\001%msg.1%\001) Bans: \002%msg.2%\002 Kicks: \002%msg.3%\002. With \001%msg.13%\001 bans and \001%msg.15%\001 kicks today (\002%msg.4%\002/\002%msg.12%\002 users)."
set black(say.en.activ.2) "BanStats: (\001%msg.1%\001) Local Bans: \002%msg.2%\002 Global Bans: \002%msg.3%\002 Kicks: \002%msg.4%\002. With \001%msg.15%\001 bans and \001%msg.17%\001 kicks today (\002%msg.12%\002/\002%msg.13%\002 users)."
...
set black(say.en.antispam.3) {	"Checking for spam.."
				"Hunting.."
				"Refreshing my uHost.."
				}
...
set black(say.en.antijoinflood.1) "\002ATTENTION\002! Joinflood detected on \002%chan%\002! Please check it out!"
...
set black(say.en.topbans.1) "Total \002BanStats\002: \001%msg%\001"
set black(say.en.topbans.2) "Today's \002BanStats\002: \001%msg%\001"
...
set black(say.en.topwords.3) "WordStats: (\001%msg.1%\001) Lines: \002%msg.2%\002 Words: \002%msg.2%\002 Letters: \002%msg.3%\002. Most active at \002%msg.12%\002. Ranked \001%msg.13%\001 out of \002%msg.15%\002 users with \001%msg.17%\001 words today."
...
set black(say.en.topwords.22) "WordStats: (\001%msg.1%\001) Host: \002%msg.2%\002 Lines: \002%msg.3%\002 Words: \002%msg.4%\002 Letters: \002%msg.12%\002. Most active at \002%msg.13%\002. Ranked \002%msg.15%\002 out of \002%msg.17%\002 users with \002%msg.19%\002 words today."
