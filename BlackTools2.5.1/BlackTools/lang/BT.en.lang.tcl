...
set black(say.en.gl.noban) "\005\[BT\]\005 ERROR! Cannot execute, user has ACCESS."
...
set black(say.en.gl.validuser) "\005\[BT\]\005 Cannot execute ( the host belongs to \002%msg.1%\002 )."
...
set black(say.en.securemode.10) "\005\[BT\]\005 Defensive mode: on"
set black(say.en.securemode.11) "\005\[BT\]\005 Defensive mode: off"
...
set black(say.en.badchan.44) "\005\[BT\]\005 \[ALERT\] ( \002%nick%\002 ) found in bad channels: (\002%chans%\002)"
...
set black(say.en.report.2) "\005\[BT\]\005 \[REPORT\] Nick: \002%msg.1%\002 was reporter by: \001%msg.2%\001 ; Reason: \002%msg.8%\002"
set black(say.en.report.3) "\005\[BT\]\005 \[REPORT\] Nick: \002%msg.1%\002 was reporter by: \001%msg.2%\001"
...
set black(say.en.gag.1) "\005\[BT\]\005 - ATTENTION - \002%gag%\002 still needs to serve a \001%minute%\001 penance for breaking the channel rules. Enjoy the sound of silence :-)"
...
set black(say.en.gag.5) "\005\[BT\]\005 - ATTENTION - %nick% can now type again on %chan%."
...
set black(say.en.gag.11) "\005\[BT\]\005 - ATTENTION - \002%gagger%\002 will be unable to type in \002%chan%\002 for \001%time%\001 because broke the channel \002rules\002."
...
set black(say.en.ungag.7) "\005\[BT\]\005 Now you can type again on \002%chan%\002. Please be more careful and do NOT break again the channel \002rules\002."
set black(say.en.ungag.8) "\005\[BT\]\005 - ATTENTION - \002%gagger%\002 can now type again on %chan%."
...
set black(say.en.cycle.2) "\005\[BT\]\005 I'll be back in %msg.1% seconds.."
...
set black(say.en.set.7) "\005\[BT\]\005 ERROR! Unable to set \001%msg.1%\001 \004%msg.set%\004 on \002%chan%\002."
...
set black(say.en.suspend.2) "Channel %chan% was suspended by \002%hand%\002 with the reason: %reason%"
...
set black(say.en.cmdsop) "o \[#chan\] \[nick\] ; v \[#chan\] \[nick\] ; ho \[#chan\] \[nick\] ; man <command> ; version ; mode \[#chan\] <+/-mode> ; cycle \[#chan\] \[reason\] ; i \[#chan\] <nick> ; activ \[#chan\] <nick> ; t \[#chan\] <text> ; myset <option> \[description\] \[reset\]/\[show\] ; h \[#chan\] \[category\] ; r \[#chan\] ; omsg \[#chan / all\] <text>"
set black(say.en.cmdadmin) "o \[#chan\] \[nick\] ; v \[#chan\] \[nick\] ; ho \[#chan\] \[nick\] ; man <command> ; version ; mode \[#chan\] <+/-mode> ; cycle \[#chan\] \[reason\] ; say \[#chan\] <text> ; act \[#chan\] <text> ; i \[#chan\] <nick> ; activ \[#chan\] <nick> ; t \[#chan\] <text> ; myset <option> \[description\] \[reset\]/\[show\] ; h \[#chan\] \[category\] ; r \[#chan\] ; omsg \[#chan / all\] <text>"
set black(say.en.cmdmanager) "o \[#chan\] \[nick\] ; v \[#chan\] \[nick\] ; ho \[#chan\] \[nick\] ; man <command> ; version ; mode \[#chan\] <+/-mode> ; cycle \[#chan\] \[reason\]/\[time\] ; say \[#chan\] <text> ; act \[#chan\] <text> ; i \[#chan\] <nick> ; activ \[#chan\] <nick> ; t \[#chan\] <text> ; myset <option> \[description\] \[reset\]/\[show\] ; h \[#chan\] \[category\] ; r \[#chan\] ; omsg \[#chan / all\] <text>"
set black(say.en.cmdbossowner) "o \[#chan\] \[nick\] ; v \[#chan\] \[nick\] ; ho \[#chan\] \[nick\] ; man <command> ; version ; mode \[#chan\] <+/-mode> ; cycle \[#chan\] \[reason\]/\[time\] ; say \[#chan\] <text> ; act \[#chan\] <text> ; broadcast <text> ; i \[#chan\] <nick> ; activ \[#chan\] <nick> ; t \[#chan\] <text> ; myset <option> \[description\] \[reset\]/\[show\] ; h \[#chan\] \[category\] ; r \[#chan\] ; msg <nick> <text> ; omsg \[#chan / all\] <text>"
set black(say.en.cmdmaster) "o \[#chan\] \[nick\] ; v \[#chan\] \[nick\] ; ho \[#chan\] \[nick\] ; man <command> ; version ; mode \[#chan\] <+/-mod> ; cycle \[#chan\] \[reason\]/\[time\] ; say \[#chan\] <text> ; act \[#chan\] <text> ; i \[#chan\] <nick> ; activ \[#chan\] <nick> ; t \[#chan\] <text> ; myset <option> \[description\] \[reset\]/\[show\] ; h \[#chan\] \[category\] ; r \[#chan\] ; msg <nick> <text> ; omsg \[#chan / all\] <text>"

set black(say.en.banvoice) "k \[#chan\] <nick> \[reason\] ; w \[#chan\] <nick>"
set black(say.en.banop) "b \[#chan\] <nick>/<host> \[-level\] \[time\] \[reason\] ; dr \[#chan\] <nick>/<host> ; bot \[#chan\] <nick>/<host> ; n \[#chan\] <nick> ; id \[#chan\] <nick> ; spam \[#chan\] <nick>/<host> ; bw \[#chan\] <nick>/<host> ; vr \[#chan\] <nick>/<host> ; gag \[#chan\] <nick> <period> <reason> ; ungag \[#chan\] <nick>/<host> ; troll \[#chan\] <nick> ; mb \[#chan\] <nick> \[reason\] ; ub \[#chan\] <nick>/<host>/<id> ; sb \[#chan\] <nick>/<host>/<id> ; banlist \[#chan\] <all>/<user>/<other> ; banstats \[total\] ; k \[#chan\] <nick> \[reason\] ; w \[#chan\] <nick>"
set black(say.en.banadmin) "b \[#chan\] <nick>/<host> \[-level\] \[time\] \[reason\] ; black \[#chan\] <nick>/<host> \[reason\] ; stick \[#chan\] <nick>/<host> \[period\] \[reason\] ; dr \[#chan\] <nick>/<host> ; bot \[#chan\] <nick>/<host> ; n \[#chan\] <nick> ; id \[#chan\] <nick> ; spam \[#chan\] <nick>/<host> ; bw \[#chan\] <nick>/<host> ; vr \[#chan\] <nick>/<host> ; gag \[#chan\] <nick> <time> <reason> ; ungag \[#chan\] <nick>/<host> ; troll \[#chan\] <nick> ; mb \[#chan\] <nick> \[reason\] ; ub \[#chan\] <nick>/<host>/<id> ; sb \[#chan\] <nick>/<host>/<id> ; banlist \[#chan\] <all>/<user>/<other> ; banstats \[total\] ; k \[#chan\] <nick> \[reason\] ; w \[#chan\] <nick>"
set black(say.en.banmanager) "b \[#chan\] <nick>/<host> \[-level\] \[period\] \[reason\] ; black \[#chan\] <nick>/<host> \[reason\] ; stick \[#chan\] <nick>/<host> \[period\] \[reason\] ; dr \[#chan\] <nick>/<host> ; bot \[#chan\] <nick>/<host> ; n \[#chan\] <nick> ; id \[#chan\] <nick> ; spam \[#chan\] <nick>/<host> ; bw \[#chan\] <nick>/<host> ; vr \[#chan\] <nick>/<host> ; gag \[#chan\] <nick> <period> <reason> ; ungag \[#chan\] <nick>/<host> ; troll \[#chan\] <nick> ; mb \[#chan\] <nick> \[reason\] ; ub \[#chan\] <nick>/<host>/<id> ; sb \[#chan\] <nick>/<host>/<id> ; banlist \[#chan\] <all>/<user>/<other> ; banstats \[total\] \[reset\] ; k \[#chan\] <nick> \[reason\] ; w \[#chan\] <nick>"
set black(say.en.banbossowner) "b \[#chan\] <nick>/<host> \[-level\] \[period\] \[global\] \[link\] \[reason\] ; black \[#chan\] <nick>/<host> \[reason\] ; stick \[#chan\] <nick>/<host> \[period\] \[reason\] ; dr \[#chan\] <nick>/<host> ; bot \[#chan\] <nick>/<host> ; n \[#chan\] <nick> ; id \[#chan\] <nick> ; spam \[#chan\] <nick>/<host> ; bw \[#chan\] <nick>/<host> ; vr \[#chan\] <nick>/<host> ; gag \[#chan\] <nick> <period> <reason> ; ungag \[#chan\] <nick>/<host> ; troll \[#chan\] <nick> ; mb \[#chan\] <nick> \[reason\] ; ub \[#chan\] <nick>/<host>/<id> \[global\] \[link\] ; sb \[#chan\] <nick>/<host>/<id> \[global\] ; banlist \[#chan\] <all>/<user>/<other>/<global> ; banstats \[total\] \[reset\] ; k \[#chan\] <nick> \[reason\] ; w \[#chan\] <nick>"
...
set black(say.en.hmaster.1) "addchan <#chan> ; delchan <#chan> <reason> ; suspend <#chan> <reason> ; unsuspend <#chan>; set \[#chan\] <option> <description> ; unset \[#chan\] <option> ; show \[#chan\] <option> ; channels ; uptime ; status ; ignore <add>/<list>/del> \[period\] <host> ; enable <command> \[user\] \[global\] ; disable <command> \[user\] \[global\]"
...
set black(say.en.greeting.5) "\005\[BT\]\005 To get a complete list with \002available commands\002 type: \002%char%h\002 ; %botnick% h ; \002(PRIVMSG) h\002"
...
set black(say.en.hello.3) "\005\[BT\]\005 I'll recognize you by hostmask '\001%msg.1%\001' from now on. Please type \002%char%h\002 in the channel to start using this bot."
set black(say.en.hello.4) "\005\[BT\]\005 Please set your password, typing: /msg \001%botnick%\001 <pass> <yourpassword>"
