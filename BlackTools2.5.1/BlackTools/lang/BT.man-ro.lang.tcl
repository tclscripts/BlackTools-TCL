...
set black(say.ro.man.96) "\[MAN\] Format perioada: <x>\002m\002 = minute, <x>\002h\002 = ore, \002d\002 = zile, \0020\002 = permanent"
...
set black(say.ro.man.118_1) "\[MAN\] Format perioada: <x>\002m\002 = minute, <x>\002h\002 = ore, \002d\002 = zile, \0020\002 = permanent"
...
set black(say.ro.man.122_1) "\[MAN\] Format perioada: <x>\002m\002 = minute, <x>\002h\002 = ore, \002d\002 = zile"
set black(say.ro.man.123) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.124) "\[MAN\] \002%char%gag\002 <nick> \[perioada\] \[motiv\] ; \002%botnick% gag\002 <nick> \[perioada\] \[motiv\] ; \002(PRIVMSG) gag\002 <#canal> <nick> \[perioada\] \[motiv\]\002."
...
set black(say.ro.man.208) "\[MAN\] Setari optionale: \002antibadquitpart-reason\002, antibadquitpart-bantime,  \002antibadquitpart-banmethod\002, antibadquitpart-banmask"
...
set black(say.ro.man.278) "\[MAN\] Setari optionale: \002badident-reason\002 (setare motiv predefinit), \002badident-bantime\002 (setare timp ban predefinit), \002badident-banmask\002 (setare metoda banmask)"
...
set black(say.ro.man.415) "\[MAN\] Setari optionale: \002badchan-reason\002, badchan-bantime, \002badchan-bmethod\002, badchan-scantime, \002showbadchan\002"
...
set black(say.ro.man.439) "\[MAN\] Setari optionale: \002seenreply\002 ; \002seenlastmsg\002"
...
set black(say.ro.man.453_1) "\[MAN\] Format perioada: <x>\002m\002 = minute, <x>\002h\002 = ore, \002d\002 = zile"
...
set black(say.ro.man.457) "\[MAN\] Setari optionale: \002idleopmax\002 <timp> (perioada timp idledeop) ; \002idlevoicemax\002 <timp> (perioada timp idlevoice) ; \002idlehalfopmax\002 <timp> (perioada timp idlehalfop)"
...
set black(say.ro.man.629) "\[MAN\] Format perioada: <x>\002m\002 = minute, <x>\002h\002 = ore, \002d\002 = zile"
set black(say.ro.man.630) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.631) "\[MAN\] \002%char%ignore list\002 ; \002%char%ignore add\002 <host> \[perioada\] \[motiv\] ; \002%char%ignore del\002 <host>"
...
set black(say.ro.man.846) "\[MAN\] \002VoiceOnMsg\002 este un modul care odata activat va face ca eggdrop-ul sa ofere voice (+v) utilizatorilor activi ce scriu un anumit numar predefinit de linii pe canal. De asemenea, utilizatorii cu acces la eggdrop sunt exclusi."
...
set black(say.ro.man.884_1) "\[MAN\] \002%char%ho +\002 (masshalfop) ; \002%char%ho -\002 (masshalfdeop)"
...
set black(say.ro.man.1209) "\[MAN\] %char%omsg\002 <#canal / all> <text> ; \002%botnick% omsg\002 <#canal / all> <text> ; \002(PRIVMSG) omsg\002 <#canal / all> <text>"
...
set black(say.ro.man.1212) "\[MAN\] \002%char%set\002 (+/-)showbadchan ; \002%botnick% set\002 (+/-)showbadchan ; \002(PRIVMSG) set\002 <#chan> (+/-)showbadchan"
...
set black(say.ro.man.1216) "\[MAN\] \002%char%set\002 (+/-)showtroll ; \002%botnick% set\002 (+/-)showtroll ; \002(PRIVMSG) set\002 <#chan> (+/-)showtroll"
...
set black(say.ro.man.1220) "\[MAN\] \002%char%set\002 (+/-)forward ; \002%botnick% set\002 (+/-)forward ; \002(PRIVMSG) set\002 <#chan> (+/-)forward"
...
set black(say.ro.man.1224) "\[MAN\] \002%char%set\002 expirebans <perioada> ; \002%botnick% set\002 expirebans <perioada> ; \002(PRIVMSG) set\002 <#chan> expirebans <perioada>"
...
set black(say.ro.man.1228) "\[MAN\] \002%char%mb\002 <nick> \[motiv\] ; \002%botnick% mb\002 <nick> \[motiv\] ; \002(PRIVMSG) mb\002 <#chan> <nick> \[motiv\]"
...
set black(say.ro.man.1137) "\[MAN\] \002%char%egg user-expire\002 <perioada> ; \002%botnick% egg user-expire\002 <perioada> ; \002(PRIVMSG) egg user-expire\002 <perioada>"
...
set black(say.ro.man.1233) "\[MAN\] \002%char%egg\002 voiceme-showtime <perioada> ; \002%botnick% egg\002 voiceme-showtime <perioada> ; \002(PRIVMSG) egg\002 voiceme-showtime <perioada>"
