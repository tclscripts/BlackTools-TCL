...
#       questions which are acutally answered in the manual. 		  #
...
#all the users who joined #TCL-HELP and shared their ideas and suggestions#
#                                                                         #
###########################################################################
...
set black(default_away) "I am using BlackTools 2.5 :-)"
...
#Ignore time (minutes) (for those who don't have access)
...
set black(antinoticesecunde) "12"
...
set black(antinotice:banmask) "2"
...
set black(antibadword:bantime) "3h"
...
set black(antichanflood:chanmodetime) "12"
...
set black(guestnick:msgmethod) "NOTICE"
...
set black(voiceonmsg:idletime) "15m"
