...
if {[matchattr $hand nmo|- $chan]} {
	blacktools:tell $nick $host $hand $chan $chan1 man.27 "$black(say.$getlang.level.7) $black(say.$getlang.level.6) $black(say.$getlang.level.5) $black(say.$getlang.level.4) $black(say.$getlang.level.3) $black(say.$getlang.level.2)"
} else {
...
if {[matchattr $hand n|- $chan]} {
	...
	blacktools:tell $nick $host $hand $chan $chan1 man.28 "$black(say.$getlang.level.7) $black(say.$getlang.level.6) $black(say.$getlang.level.5)"	
		}
	}
}
...
if {[matchattr $hand nmo|M $chan]} {
	...
	blacktools:tell $nick $host $hand $chan $chan1 man.1206_1 none
	}	
}
...
banstats {
if {[matchattr $hand nmo|M $chan]} {
	blacktools:tell $nick $host $hand $chan $chan1 man.834 none
	blacktools:tell $nick $host $hand $chan $chan1 man.835 none
	blacktools:tell $nick $host $hand $chan $chan1 man.836 none
	blacktools:tell $nick $host $hand $chan $chan1 man.837 none
	}
}
...
if {[matchattr $hand nmo|M $chan]} {
	...
	blacktools:tell $nick $host $hand $chan $chan1 man.855 none
	}
}
...
seenlastmsg {
if {[matchattr $hand nmo|M $chan]} {
	blacktools:tell $nick $host $hand $chan $chan1 man.888 none
	blacktools:tell $nick $host $hand $chan $chan1 man.889 none
	blacktools:tell $nick $host $hand $chan $chan1 man.890 none
	blacktools:tell $nick $host $hand $chan $chan1 man.891 none
	}
}
...
if {[matchattr $hand nmo|MAOV $chan]} {
	...
	blacktools:tell $nick $host $hand $chan $chan1 man.951 none
	}
}
...
egg {
if {[matchattr $hand nm|- $chan]} {
	blacktools:tell $nick $host $hand $chan $chan1 man.990 none
	blacktools:tell $nick $host $hand $chan $chan1 man.991 none
	blacktools:tell $nick $host $hand $chan $chan1 man.992 none
	}
}
...
if {[matchattr $hand nm|- $chan]} {
	...
	blacktools:tell $nick $host $hand $chan $chan1 man.1101 none
	}
}
