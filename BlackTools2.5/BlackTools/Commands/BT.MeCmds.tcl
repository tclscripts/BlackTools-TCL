...
if {$otherchan == "1"} {
	quote:process $nick $host $hand $chan $chan1 $type $who $quote [lrange [split $arg] 3 end] $next
	} else {
	quote:process $nick $host $hand $chan $chan1 $type $who $quote [lrange [split $arg] 2 end] $next
	}
	}
}
