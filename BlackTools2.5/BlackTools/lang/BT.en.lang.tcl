...
set black(say.en.gl.noban) "\005\[BT\]\005 ERROR! Unable to ban, user has ACCESS."
set black(say.en.gl.notonchan) "\005\[BT\]\005 ERROR! I am not on \001%chan%\001"
...
set black(say.en.gl.novalidchan) "\005\[BT\]\005 ERROR! Invalid channel."
set black(say.en.gl.nomem) "\005\[BT\]\005 ERROR! I have no memory record of that user."
set black(say.en.gl.noaccess) "\005\[BT\]\005 ERROR! Doesn't have access on \002%chan%\002."
set black(say.en.gl.noop) "\005\[BT\]\005 ERROR! I'm not opped on \002%chan%\002."
set black(say.en.gl.nomodif) "\005\[BT\]\005 ERROR! Cannot modify a user with equal or higher access than your own."
set black(say.en.gl.usernotonchan) "\005\[BT\]\005 ERROR! \001%msg.1%\001 is not on \002%chan%\002."
set black(say.en.gl.nocmem) "\005\[BT\]\005 ERROR! I have no memory record of channel \001%msg.1%\001"
set black(say.en.gl.isowner) "\005\[BT\]\005 \002%msg.1%\002 has already \002OWNER\002 access."
set black(say.en.gl.usernotexist) "\005\[BT\]\005 \002%msg.1%\002 does not exist."
...
set black(say.en.gl.invalidlevel) "\005\[BT\]\005 Sorry, you have insufficient access to perform that command (use \002%msg%\002)"
set black(say.en.gl.nounban) "\005\[BT\]\005 Sorry, you have insufficient access to remove the ban \002%msg.1%\002."
set black(say.en.gl.hasop) "\005\[BT\]\005 ERROR! User is opped. I can't proceed."
...
set black(say.en.activ.1) "\005\[BT\]\005 BanStats: (\001%msg.1%\001) Bans: \002%msg.2%\002 Kicks: \002%msg.3%\002. With \001%msg.13%\001 bans and \001%msg.15%\001 kicks today (\002%msg.4%\002/\002%msg.12%\002 users)."
set black(say.en.activ.2) "\005\[BT\]\005 BanStats: (\001%msg.1%\001) Local Bans: \002%msg.2%\002 Global Bans: \002%msg.3%\002 Kicks: \002%msg.4%\002. With \001%msg.15%\001 bans and \001%msg.17%\001 kicks today (\002%msg.12%\002/\002%msg.13%\002 users)."
...
set black(say.en.antipub.1) "Advertising is not permited on this channel"
set black(say.en.antipub.2) "Advertising is \002NOT\002 permitted and will result in a ban next time."
set black(say.en.antipub.3) "\005\[BT\]\005 *** END Antipub Exceptions List ***"
set black(say.en.antipub.4) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in \002Antipub Exceptions List\002 of %chan%."
set black(say.en.antipub.5) "\005\[BT\]\005 Removed \002antipub exception\002 with nr. \001%msg.1%\001 from \002%chan%\002."
set black(say.en.antipub.6) "\005\[BT\]\005 Added \002%msg.8%\002 with nr. \001%msg.1%\001 to Antipub Exceptions for \002%chan%\002."
set black(say.en.antipub.7) "\005\[BT\]\005 \002Antipub Exception List\002 for %chan% is:"
set black(say.en.antipub.8) "\005\[BT\]\005 To see the next set of exceptions, type: \001%char%antipub list -next\001 (\002%counter%\002 Exceptions left)"
set black(say.en.antipub.9) "\005\[BT\]\005 To see the next set of exceptions, type: \001%char%antipub %chan% list -next\001 (\002%counter%\002 Exceptions left)"
...
set black(say.en.badhost.4) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in \002BadHosts List\002 of \001%chan%\001."
...
set black(say.en.antinotice.1) "Channel NOTICEs are not allowed in here"
set black(say.en.antinotice.2) "Please do not use NOTICE in here"

#################################### AntiCtcp #################################

set black(say.en.antictcp.1) "Channel CTCP's are not allowed in here"
...
set black(say.en.badword.5) "\005\[BT\]\005 Removed \002badword\002 with no. \001%msg.1%\001 from %chan%."
...
set black(say.en.antibadword.8) "\005\[BT\]\005 To see the next set of entries, type: \001%char%badword list -next\001 (\002%counter%\002 BadWords left)"
set black(say.en.antibadword.9) "\005\[BT\]\005 To see the next set of entries, type: \001%char%badword %chan% list -next\001 (\002%counter%\002 BadWords left)"
...
set black(say.en.antibadquitpart.1) "Inappropriate part/quit message"
set black(say.en.antibadquitpart.3) "\005\[BT\]\005 *** END Bad parts/quits Exceptions List ***"
set black(say.en.badquitpart.4) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in \002Bad part/quit Exceptions List\002 of \001%chan%\001."
set black(say.en.badquitpart.5) "\005\[BT\]\005 Removed \002bad part/quit\002 with no. \001%msg.1%\001 from %chan%."
set black(say.en.badquitpart.6) "\005\[BT\]\005 Added \002%msg.8%\002 with no. \001%msg.1%\001 to Bad part/quit Exceptions List for \002%chan%\002."
set black(say.en.antibadquitpart.7) "\005\[BT\]\005 \002Bad part/quit Exceptions List\002 for \001%chan%\001 is:"
set black(say.en.antibadquitpart.8) "\005\[BT\]\005 To see the next set of exceptions, type: \001%char%badquitpart list -next\001 (\002%counter%\002 Exceptions left)"
set black(say.en.antibadquitpart.9) "\005\[BT\]\005 To see the next set of exceptions, type: \001%char%badquitpart %chan% list -next\001 (\002%counter%\002 Exceptions left)"
...
set black(say.en.antispam.3) {	"\005\[BT\]\005 Checking for spam.."
				"\005\[BT\]\005 Hunting.."
				"\005\[BT\]\005 Refreshing my uHost.."
				}
...
set black(say.en.anticaps.1) "Stop using CAPS LOCK (capital letters)"
set black(say.en.anticaps.2) "Please do NOT use excessive CAPS LOCK! (capital letters)"
...
set black(say.en.badrealname.4) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in \002BadRealname List\002 of \001%chan%\001."
...
set black(say.en.badnick.4) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in \002BadNicks List\002 of \001%chan%\001."
...
set black(say.en.badident.4) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in \002BadIdents List\002 of \001%chan%\001."
set black(say.en.badident.5) "\005\[BT\]\005 Removed \002badident\002 with no. \001%msg.1%\001 from \001%chan%\001."
...
set black(say.en.antijoinflood.1) "ATTENTION! Joinflood detected on %chan%! Please check it out!"

################################# AntiChanFlood #####################################

set black(say.en.antichanflood.1) "Text flooding is not permissable in here"
set black(say.en.antichanflood.2) "Please do NOT flood"

################################### NickFlood #######################################

set black(say.en.nickflood.1) "Nick flood is not permitted in here"
...
set black(say.en.securemode.1) "\002ATTENTION:\002 You just tried to join %chan% but the channel is \002lockdown\002 (\002+mD\002). Since we're being attacked by bots, please type: \002/msg %botnick% check %chan% %msg.1%\002 to prove that you're a human. If you do, you will be permitted to join. If you mess up, nothing will happen."
...
set black(say.en.securemode.4) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in \002SecureMode Exceptions List\002 of \001%chan%\001."
...
set black(say.en.voiceme.1) "The channel is \002moderated (mode +m)\002. If you wanna be able to chat in \002%chan%\002 then use:\002 /msg %botnick% voiceme %chan%\002. Requires to be \002registered and logged into X\002. If you don't have a Cservice username, go to \002https://cservice.undernet.org/live\002 and create one."
set black(say.en.voiceme.2) "The channel is NOT \002moderated (mode +m)\002 anymore. Enjoy!"
set black(say.en.voiceme.3) "You received \002voice(+)\002 on \002%chan%\002. Have a nice chat!"
set black(say.en.voiceme.4) "You are already \002voiced\002 in \002%chan%\002."

################################## BanStats #####################################

set black(say.en.topbans.1) "\005\[BT\]\005 Total \002BanStats\002: \001%msg%\001"
set black(say.en.topbans.2) "\005\[BT\]\005 Today's \002BanStats\002: \001%msg%\001"
set black(say.en.topbans.8) "\005\[BT\]\005 \002BanStats\002 reseted on \001%chan%\001"
set black(say.en.topbans.9) "(To see the next set of entries, type: \002%char%topbans -next\002)"
set black(say.en.topbans.10) "\005\[BT\]\005 \002%chan%\002's Ban List is empty."
set black(say.en.topbans.11) "(To see the next set of entries, type: \002%char%topbans total -next\002)"
set black(say.en.topbans.12) "(To see the next set of entries, type: \002%char%topbans %chan% total -next\002)"
set black(say.en.topbans.13) "(To see the next set of entries, type: \002%char%topbans %chan% -next\002)"
set black(say.en.topbans.14) "\005\[BT\]\005 There are no bans on \002%chan%\002 today."

################################# TopWords #####################################

set black(say.en.topwords.1) "\005\[BT\]\005 Total \002TopWords\002: \001%msg%\001"
set black(say.en.topwords.2) "\005\[BT\]\005 Today's \002TopWords\002: \001%msg%\001"
set black(say.en.topwords.3) "\005\[BT\]\005 WordStats: (\001%msg.1%\001) Lines: \002%msg.2%\002 Words: \002%msg.2%\002 Letters: \002%msg.3%\002. Most active at \002%msg.12%\002. Ranked \001%msg.13%\001 out of \002%msg.15%\002 users with \001%msg.17%\001 words today."
set black(say.en.topwords.4) "\005\[BT\]\005 TopWords: Sorry, I don't have any stats about \002%msg.1%\002."
...
set black(say.en.topwords.22) "\005\[BT\]\005 WordStats: (\001%msg.1%\001) Host: \002%msg.2%\002 Lines: \002%msg.3%\002 Words: \002%msg.4%\002 Letters: \002%msg.12%\002. Most active at \002%msg.13%\002. Ranked \002%msg.15%\002 out of \002%msg.17%\002 users with \002%msg.19%\002 words today."
...
set black(say.en.guestnick.5) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in \002GuestNicks List\002."
...
set black(say.en.reportchan) "\005\[BT\]\005 Added ban on \002%chan%\002 for host \002%banmask%\002 with reason: \002%reason%\002 and expiration time: \002%bantime%\002."
set black(say.en.reportchan.1) "\005\[BT\]\005 \[\002%nick%\002\] added ban on \002%chan%\002 for host \002%banmask%\002 with reason: \002%reason%\002 and expiration time: \002%bantime%\002."
set black(say.en.reportchan.2) "\005\[BT\]\005 \[\002%nick%\002\] added Gag on \002%chan%\002 for host \002%banmask%\002 with reason: \002%reason%\002 and expiration time: \002%bantime%\002."
set black(say.en.backchan.1) "\005\[BT\]\005 Found \002%msg.1%\002 in \002%chan%\002's BanList matching \002%msg.2%\002."

################################ CloneScan ###################################

set black(say.en.clonescan.1) "Too many clients from your host \002*!*%clone%\002. Clones are prohibited!"
set black(say.en.clonescan.2) "\005\[BT\]\005 No clones on \001%chan\001."
set black(say.en.clonescan.3) "*** END Clones Exceptions List ***"
set black(say.en.clonescan.4) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in \002Clones Exceptions List\002."
set black(say.en.clonescan.5) "\005\[BT\]\005 Removed \002exception\002 with no. \001%msg.1%\001 from \002%chan%\002."
set black(say.en.clonescan.6) "\005\[BT\]\005 Added \001%msg.1%\001 with no. \002%msg.2%\002 in \002Clones Exceptions List\002"
...
set black(say.en.badchan.17) "\005\[BT\]\005 ERROR! No entries matching for no. \002%msg.1%\002 in my BadChans List."
...
set black(say.en.badchan.40) "\002ATTENTION!\002 You were found sitting in one or more blacklisted channels! You have\002 30 seconds\002 to leave:\002 %badchans%\002, otherwise you'll be banned. Thank You!"
...
set black(say.en.badchan.43) "\005\005\[BT\]\005\005 \002BadChan\002 is already activated."
...
set black(say.en.anunt.13) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in \002%chan%'s\002 Adverts List."
...
set black(say.en.autobroadcast.2) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in my \002AutoBroadcast List\002."
...
set black(say.en.limit.6) "\005\[BT\]\005 Current channel limit is \002+10\002."
set black(say.en.limit.7) "\005\[BT\]\005 \002AutoLimit\002 module turned \001OFF\001 in \002%chan%\002."
set black(say.en.limit.9) "\005\[BT\]\005 ERROR! You cannot set limit less than \0022\002."
set black(say.en.limit.10) "\005\[BT\]\005 Setting limit to \002+2\002."
set black(say.en.limit.11) "\005\[BT\]\005 ERROR! You cannot set limit higher than \002500\002."
...
set black(say.en.seen.10) " \002%newnick%\002 is still here."
set black(say.en.seen.11) "Unable to see \002%userentry%\002 right now on \001%chan%\001"
...
set black(say.en.seen.18) "\005\[BT\]\005 I don't remember seeing \002%msg.1%\002 lately.."
set black(say.en.seen.19) " \002%latest%\002 is still here."
...
set black(say.en.seen.29) "\005\[BT\]\005 %entry% (%host%) was last seen %output% ago %date%, on %chan% saying: \"%lastmsg%\""
set black(say.en.seen.30) "\005\[BT\]\005 Found (%num%) results \"%entry%\". Most recent \002%latest%\002 (%host%) was last seen %output% ago %date%, on %chan% saying: \"%lastmsg%\""
set black(say.en.seen.31) "\005\[BT\]\005 As far as I know, \002%msg.1%\002 hasn't said anything."
...
set black(say.en.seen.39) "\005\[BT\]\005 ATTENTION %msg.1%! \002%msg.2%\002 was looking for you with \002%char%seen\002 on \002%chan%\002 about \002%msg.3%\002 ago."

################################# Greet ######################################

set black(say.en.greet.1) "\005\[BT\]\005 Set as greet message for \002%chan%\002: \001%msg%\001"
...
set black(say.en.leave.1) "\005\[BT\]\005 Set as leave message for \002%chan%\002: \001%msg%\001"
...
set black(say.en.tcl.1) "\005\[BT\]\005 Current loaded scripts are:"
...
set black(say.en.tcl.9) "\005\[BT\]\005 There are \002\"%msg.1%\"\002 tcls. Listing 30.. (Loaded scripts are listed in BOLD)"
...
set black(say.en.tcl.18) "\005\[BT\]\005 ERROR! You cannot unload this script!"
set black(say.en.tcl.19) "\005\[BT\]\005 ERROR! I was \002unable to download\002 the script \001%msg.1%\001 from the given link."
...
set black(say.en.next.6) "\005\[BT\]\005 \002ATTENTION\002: \001%nick%\001 needs help on \002%chan%\002. This is number \002%counter%\002 in line."
...
set black(say.en.next.11) "\005\[BT\]\005 \002ATTENTION\002: \001%current%\001 is being helped \002right now\002 by \001%nick%\001 (%hand%)"
set black(say.en.next.13) "\005\[BT\]\005 ERROR! \001%msg.1%\001 is in the help list, but hasn't been helped yet."
set black(say.en.next.14) "\005\[BT\]\005 ERROR! \001%msg.1%\001 is not in help list."
set black(say.en.next.15) "\005\[BT\]\005 \002ATTENTION\002: \001%current%\001 has received \002help\002 from \001%nick%\001 (%hand%)."
set black(say.en.next.17) "\005\[BT\]\005 ERROR! \002%msg.1%\002 has to receive help first \001%msg.1%\001"
set black(say.en.next.19) "\005\[BT\]\005 Skipped \002%msg.1%\002 (user has been moved to the end of the list)"

#################################### Quote #####################################

set black(say.en.quote.1) "\005\[BT\]\005 Successfully added Quote no. \002%msg.1%\002 to database."
set black(say.en.quote.2) "\005\[BT\]\005 *** END Quote List ***"
set black(say.en.quote.3) "\005\[BT\]\005 Quote \001#%msg.1%\001 :: \002Created on\002: %msg.2%"
set black(say.en.quote.4) "\005\[BT\]\005 \001%msg.1%\001 :: %msg.2% :: \002Created on\002: %msg.3%"
...
set black(say.en.quote.9) "\005\[BT\]\005 To see the next set of entries, type: \001%char%quote list -next\001 (\002%counter%\002 quotes left)"
set black(say.en.quote.10) "\005\[BT\]\005 Successfully removed Quote no. \001%msg.1%\001 from \002%chan%\002's database."
set black(say.en.quote.11) "\005\[BT\]\005 ERROR! I have no record of that quote."
set black(say.en.quote.12) "\005\[BT\]\005 \002Quote of Day\002"
set black(say.en.quote.13) "\005\[BT\]\005 ERROR! No entries matching for no. \001%msg.1%\001 in \002Quote List\002 of \002%chan%\002"
set black(say.en.quote.14) "\005\[BT\]\005 To see the next set of entries, type: \001%char%quote %chan% list -next\001 (\002%counter%\002 quotes left)"
...
set black(say.en.notes.4) "\005\[BT\]\005 ERROR! No entries matching for no. #\002%msg.1%\002."
...
set black(say.en.notes.11) "\005\[BT\]\005 You have \001%msg.1%\001 unread notes. Those are: \002%msg.7%\002. Total notes: \001%msg.2%\001"
set black(say.en.notes.12) "\005\[BT\]\005 You have \001%msg.1%\001 unread notes. Total notes: \002%msg.2%\002"
...
set black(say.en.notes.13) "\005\[BT\]\005 ERROR! Your \002Notes List\002 is empty."
...
set black(say.en.report.1) "\005\005\[BT\]\005\005 You're sending requests too fast. Calm down and try again after \002%msg.1% seconds\002. Thanks!"
set black(say.en.report.2) "\005\005\[BT\]\005\005 \[REPORT\] Nick: \002%msg.1%\002 was reporter by: \001%msg.2%\001 ; Reason: \002%msg.8%\002"
set black(say.en.report.3) "\005\005\[BT\]\005\005 \[REPORT\] Nick: \002%msg.1%\002 was reporter by: \001%msg.2%\001"
set black(say.en.report.4) "\005\005\[BT\]\005\005 Your report has been sent to our operators team. Thanks you!"
set black(say.en.report.5) "\005\005\[BT\]\005\005 You can't report yourself dork!!"
...
set black(say.en.myset.14) "\005\005\[BT\]\005\005 You have to specify 4 colors from those available. Available colors are:\002bold\002 \001underline\001 \0034red\003 \00312blue\003 \0033green\003 \0038yellow\003 \0037orange\003 \00310cyan\003 \00314grey\003 \0035brown\003 \0036purple\003 \00313pink\003 black"
set black(say.en.myset.15) "\005\005\[BT\]\005\005 One of the colors is invalid. Available colors are: \002bold\002 \001underline\001 \0034red\003 \00312blue\003 \0033green\003 \0038yellow\003 \0037orange\003 \00310cyan\003 \00314grey\003 \0035brown\003 \0036purple\003 \00313pink\003 black"
set black(say.en.myset.16) "\005\005\[BT\]\005\005 Your \002colors\002 are now set to: \001%msg%\001"
set black(say.en.myset.17) "\005\005\[BT\]\005\005 You have to specify one of the available chars. Available chars are: \001%msg%\001"
set black(say.en.myset.18) "\005\005\[BT\]\005\005 Your \002mychar\002 is now set to: \001%msg.1%\001"
...
set black(say.en.bot.6) "\005\[BT\]\005 For unban use: \002/msg %botnick% unbanme %chan% %msg%\002"
set black(say.en.bot.7) "\005\[BT\]\005 Congratulations! Your ban from %chan% has been removed. You can now rejoin!" 
...
set black(say.en.b.6) "\005\[BT\]\005 The maximum period for your ban level is \0027d\002 (20160 minute)"
...
set black(say.en.b.10) "\005\[BT\]\005 %msg.1% is not a valid banmask."
...
set black(say.en.k.2) "\005\005\[BT\]\005\005 %msg.1% has access on %chan%"
...
set black(say.en.gag.1) "- ATTENTION - \002%gag%\002 still needs to serve a \002%minute%\002 penance for breaking the channel rules. Enjoy the sound of silence :-)"
...
set black(say.en.gag.5) "- ATTENTION - %nick% can now type again on %chan%."
set black(say.en.gag.6) "No reason supplied"
set black(say.en.gag.7) "\005\[BT\]\005 The maximum \002GAG period\002 for your access level is \0017d\001 (20160 minutes)"
set black(say.en.gag.10) "You have been silenced on %chan% for \002%time%\002 because you are violating the channel \002rules\002."
set black(say.en.gag.11) "- ATTENTION - \002%gagger%\002 will be unable to type in %chan% for \002%time%\002 because broke the channel \002rules\002."
...
set black(say.en.banlist.5) "\005\005\[BT\]\005\005 \002%msg.2%\002 ; \[ID: %msg.1%\] ; \002%msg.3%\002 ; Added by: \002%msg.4%\002 ; Since: \002%msg.12%\002 ; EXP: \002%msg.13%\002 \002%msg.15%\002 \002%msg.17%\002 ; Reason: \002%msg.20%\002"
...
set black(say.en.banlist.9) "\005\005\[BT\]\005\005 \002%msg.2%\002 ; \[ID: %msg.1%\] ; \002%msg.3%\002 ; Since: \002%msg.4%\002 ; EXP: %msg.12% \002%msg.13%\002 \002%msg.15%\002 ; Reason: \002%msg.16%\002"
...
set black(say.en.banlist.11) "\005\005\[BT\]\005\005 \002%msg.2%\002 ; \[ID: %msg.1%\] ; \002%msg.3%\002 ; Added by: \002%msg.4%\002 ; Since: \002%msg.12%\002 ; EXP: \002%msg.13%\002 ; Reason: \002%msg.14%\002"
set black(say.en.banlist.12) "\005\005\[BT\]\005\005 \002%msg.2%\002 ; \[ID: %msg.1%\] ; \002%msg.3%\002 ; Since: \002%msg.4%\002 ; EXP: \002%msg.12%\002 ; Reason: \002%msg.11%\002"
...
set black(say.en.status.1) "\005\[BT\]\005 Script version: \001%msg.1% %msg.2%\001 - Eggdrop version: \002%msg.3%\002"
...
set black(say.en.cycle.1) { "\005\[BT\]\005 Doing exercise.."
			    "\005\[BT\]\005 Trying to fix something.."
			    "\005\[BT\]\005 Coming back.."
			    "\005\[BT\]\005 I'll return in a moment.."
			    }
set black(say.en.cycle.2) "\005\005\[BT\]\005\005 I'll be back in %msg.1% seconds.."
...
set black(say.en.chat.1) "\005\005\[BT\]\005\005 DCC Chat - Initializing..."
set black(say.en.chat.2) "\005\005\[BT\]\005\005 You have not set a password, please do so now: /msg %botnick% pass \001<your password>\001"

################################## Version ##################################

set black(say.en.version.1) "\005\[BT\]\005 SCRIPT VERSION: \001BlackTools %msg.1%\001 Created by \002BLaCkShaDoW\002. For other details ---= \002WwW.TclScripts.Net\002 or #TCL-HELP @ UNDERNET"

################################# ub ######################################

set black(say.en.ub.1) "\005\[BT\]\005 I haven't found any bans matching \002%msg.1%\002"
set black(say.en.ub.2) "\005\[BT\]\005 Removed \001%msg.1%\001 bans (\002%msg.2%\002 found) matching \001%msg.3%\001"
set black(say.en.ub.3) "\005\[BT\]\005 I haven't found any \[GLOBAL\] bans matching \002%msg.1%\002"
set black(say.en.ub.4) "\005\[BT\]\005 Removed \001%msg.1%\001 \[GLOBAL\] bans that matching \002%msg.2%\003"
...
set black(say.en.ub.9) "\005\[BT\]\005 Removed ban matching the \[ID: \002%msg.3%\003\]"
set black(say.en.ub.10) "\005\[BT\]\005 Removed \[GLOBAL\] ban matching the \[ID: \002%msg.2%\003\]"
...
set black(say.en.set.5) "\005\[BT\]\005 ERROR! Unable to set \001%msg.1%\001 on \002%chan%\002."
set black(say.en.set.6) "\005\[BT\]\005 Set \001%msg.1%\001 for \002%chan%\002"
set black(say.en.set.7) "\005\[BT\]\005 ERROR! Unable to set \001%msg.1%\001 %msg.set% on \002%chan%\002."
set black(say.en.set.8) "\005\[BT\]\005 Set \001%msg.1%\001 %msg.set% for \002%chan%\002"
...
set black(say.en.unset.2) "\005\[BT\]\005 Disabled \001%msg.1%\001 from \002%chan%\002."
...
set black(say.en.ignore.4) "\005\[BT\]\005 \001%msg.1%\001 Added by: \002%msg.2%\002 Reason: \001%msg.6%\001 EXP: \002%msg.3%\002"
set black(say.en.ignore.5) "\005\[BT\]\005 ERROR! \002%msg.1%\002 has ignore already."
...
set black(say.en.show.6) "\005\[BT\]\005 Current \001%msg.1%\001 is set to: \002%msg.8%\002"
set black(say.en.show.7) "\005\[BT\]\005 Currently \002%msg.1%\002 is enabled."
set black(say.en.show.8) "\005\[BT\]\005 Currently \002%msg.1%\002 is disabled."
...
set black(say.en.info.2) "\005\[BT\]\005 \[CHAN\] \002%msg.1%\002 -- AUTOMODE: \001%msg.2%\001 -- STATS: \002%char%activ %msg.3%\002"
...
set black(say.en.info.36) "\005\005\[BT\]\005\005 \[Settings\] \001%msg%\001"
...
set black(say.en.r.1) "Refreshing topic...."
...
set black(say.en.h.16) "\005\[BT\]\005 You're sending requests too fast. Calm down and try again after \002%msg.1% minutes\002. Thanks!"
...
set black(say.en.h.25) "\005\005\[BT\]\005\005 \002%char%h\002 \001cmds\001 ; \002%char%h\002 \001ban\001 ; \002%char%h\002 \001add\001 ; \002%char%h\002 \001chaninfo\001 ; \002%char%h\002 \001BTinfo\001 ; \002%char%h\002 \001module\001 ; \002%char%h\002 \001master\001"
set black(say.en.h.26) "\005\005\[BT\]\005\005 \002h\002 \001cmds\001 ; \002h\002 \001ban\001 ; \002h\002 \001add\001 ; \002h\002 \001chaninfo\001 ; \002h\002 \001BTinfo\001 ; \002h\002 \001module\001 ; \002h\002 \001master\001"
set black(say.en.h.27) "\005\005\[BT\]\005\005 %botnick% \002h\002 \001cmds\001 ; %botnick% \002h\002 \001ban\001 ; %botnick% \002h\002 \001add\001 ; %botnick% \002h\002 \001module\001 ; %botnick% \002h\002 \001master\001"
...
set black(say.en.cmdsvoice) "v \[#chan\] \[nick\] ; man <command> ; version ; i \[#chan\] <nick> ; activ \[#chan\] <nick> ; myset <option> \[description\] \[reset\]/\[show\] ; h \[#chan\] \[category\]"
set black(say.en.cmdsop) "o \[#chan\] \[nick\] ; v \[#chan\] \[nick\] ; ho \[#chan\] \[nick\] ; man <command> ; version ; mode \[#chan\] <+/-mode> ; cycle \[#chan\] \[reason\] ; i \[#chan\] <nick> ; activ \[#chan\] <nick> ; t \[#chan\] <text> ; myset <option> \[description\] \[reset\]/\[show\] ; h \[#chan\] \[category\] ; r \[#chan\]"
set black(say.en.cmdadmin) "o \[#chan\] \[nick\] ; v \[#chan\] \[nick\] ; ho \[#chan\] \[nick\] ; man <command> ; version ; mode \[#chan\] <+/-mode> ; cycle \[#chan\] \[reason\] ; say \[#chan\] <text> ; act \[#chan\] <text> ; i \[#chan\] <nick> ; activ \[#chan\] <nick> ; t \[#chan\] <text> ; myset <option> \[description\] \[reset\]/\[show\] ; h \[#chan\] \[category\] ; r \[#chan\]"
set black(say.en.cmdmanager) "o \[#chan\] \[nick\] ; v \[#chan\] \[nick\] ; ho \[#chan\] \[nick\] ; man <command> ; version ; mode \[#chan\] <+/-mode> ; cycle \[#chan\] \[reason\]/\[time\] ; say \[#chan\] <text> ; act \[#chan\] <text> ; i \[#chan\] <nick> ; activ \[#chan\] <nick> ; t \[#chan\] <text> ; myset <option> \[description\] \[reset\]/\[show\] ; h \[#chan\] \[category\] ; r \[#chan\]"
set black(say.en.cmdbossowner) "o \[#chan\] \[nick\] ; v \[#chan\] \[nick\] ; ho \[#chan\] \[nick\] ; man <command> ; version ; mode \[#chan\] <+/-mode> ; cycle \[#chan\] \[reason\]/\[time\] ; say \[#chan\] <text> ; act \[#chan\] <text> ; broadcast <text> ; i \[#chan\] <nick> ; activ \[#chan\] <nick> ; t \[#chan\] <text> ; myset <option> \[description\] \[reset\]/\[show\] ; h \[#chan\] \[category\] ; r \[#chan\] ; msg <nick> <text>"
set black(say.en.cmdmaster) "o \[#chan\] \[nick\] ; v \[#chan\] \[nick\] ; ho \[#chan\] \[nick\] ; man <command> ; version ; mode \[#chan\] <+/-mod> ; cycle \[#chan\] \[reason\]/\[time\] ; say \[#chan\] <text> ; act \[#chan\] <text> ; i \[#chan\] <nick> ; activ \[#chan\] <nick> ; t \[#chan\] <text> ; myset <option> \[description\] \[reset\]/\[show\] ; h \[#chan\] \[category\] ; r \[#chan\] ; msg <nick> <text>"

set black(say.en.banvoice) "k \[#chan\] <nick> \[reason\] ; w \[#chan\] <nick>"
set black(say.en.banop) "b \[#chan\] <nick>/<host> \[-level\] \[time\] \[reason\] ; dr \[#chan\] <nick>/<host> ; bot \[#chan\] <nick>/<host> ; n \[#chan\] <nick> ; id \[#chan\] <nick> ; spam \[#chan\] <nick>/<host> ; bw \[#chan\] <nick>/<host> ; vr \[#chan\] <nick>/<host> ; gag \[#chan\] <nick> <period> <reason> ; ungag \[#chan\] <nick>/<host> ; troll \[#chan\] <nick> ; ub \[#chan\] <nick>/<host>/<id> ; sb \[#chan\] <nick>/<host>/<id> ; banlist \[#chan\] <all>/<user> ; banstats \[total\] ; k \[#chan\] <nick> \[reason\] ; w \[#chan\] <nick>"
set black(say.en.banadmin) "b \[#chan\] <nick>/<host> \[-level\] \[time\] \[reason\] ; black \[#chan\] <nick>/<host> \[reason\] ; stick \[#chan\] <nick>/<host> \[period\] \[reason\] ; dr \[#chan\] <nick>/<host> ; bot \[#chan\] <nick>/<host> ; n \[#chan\] <nick> ; id \[#chan\] <nick> ; spam \[#chan\] <nick>/<host> ; bw \[#chan\] <nick>/<host> ; vr \[#chan\] <nick>/<host> ; gag \[#chan\] <nick> <time> <reason> ; ungag \[#chan\] <nick>/<host> ; troll \[#chan\] <nick> ; ub \[#chan\] <nick>/<host>/<id> ; sb \[#chan\] <nick>/<host>/<id> ; banlist \[#chan\] <all>/<user> ; banstats \[total\] ; k \[#chan\] <nick> \[reason\] ; w \[#chan\] <nick>"
set black(say.en.banmanager) "b \[#chan\] <nick>/<host> \[-level\] \[period\] \[reason\] ; black \[#chan\] <nick>/<host> \[reason\] ; stick \[#chan\] <nick>/<host> \[period\] \[reason\] ; dr \[#chan\] <nick>/<host> ; bot \[#chan\] <nick>/<host> ; n \[#chan\] <nick> ; id \[#chan\] <nick> ; spam \[#chan\] <nick>/<host> ; bw \[#chan\] <nick>/<host> ; vr \[#chan\] <nick>/<host> ; gag \[#chan\] <nick> <period> <reason> ; ungag \[#chan\] <nick>/<host> ; troll \[#chan\] <nick> ; ub \[#chan\] <nick>/<host>/<id> ; sb \[#chan\] <nick>/<host>/<id> ; banlist \[#chan\] <all>/<user> ; banstats \[total\] \[reset\] ; k \[#chan\] <nick> \[reason\] ; w \[#chan\] <nick>"
set black(say.en.banbossowner) "b \[#chan\] <nick>/<host> \[-level\] \[period\] \[global\] \[link\] \[reason\] ; black \[#chan\] <nick>/<host> \[reason\] ; stick \[#chan\] <nick>/<host> \[period\] \[reason\] ; dr \[#chan\] <nick>/<host> ; bot \[#chan\] <nick>/<host> ; n \[#chan\] <nick> ; id \[#chan\] <nick> ; spam \[#chan\] <nick>/<host> ; bw \[#chan\] <nick>/<host> ; vr \[#chan\] <nick>/<host> ; gag \[#chan\] <nick> <period> <reason> ; ungag \[#chan\] <nick>/<host> ; troll \[#chan\] <nick> ; ub \[#chan\] <nick>/<host>/<id> \[global\] \[link\] ; sb \[#chan\] <nick>/<host>/<id> \[global\] ; banlist \[#chan\] <all>/<user>/<global> ; banstats \[total\] \[reset\] ; k \[#chan\] <nick> \[reason\] ; w \[#chan\] <nick>"
set black(say.en.banmaster) "b \[#chan\] <nick>/<host> \[-nivel\] \[period\] \[reason\] ; black \[#chan\] <nick>/<host> \[reason\] ; stick \[#chan\] <nick>/<host> \[period\] \[period\] ; dr \[#chan\] <nick>/<host> ; bot \[#chan\] <nick>/<host> ; n \[#chan\] <nick> ; id \[#chan\] <nick> ; spam \[#chan\] <nick>/<host> ; bw \[#chan\] <nick>/<host> ; vr \[#chan\] <nick>/<host> ; gag \[#chan\] <nick> <period> <reason> ; ungag \[#chan\] <nick>/<host> ; troll \[#chan\] <nick> ; ub \[#chan\] <nick>/<host>/<id> ; sb \[#chan\] <nick>/<host>/<id> ; banlist \[#chan\] <all>/<user> ; banstats \[total\] ; k \[#chan\] <nick> \[reason\] ; w \[#chan\] <nick>"

set black(say.en.addadmin) "add \[#chan\] <level> <user chanserv> ; adduser \[#chan\] <level> <nickname> ; userlist \[#chan\] <level>/<all> ; info \[#chan\] <user>/<#chan> ; delacc \[#chan\] <user> ; auto \[#chan\] <+/-o> <user> ; auto \[#chan\] <+/-v> <user> ; s \[#chan\] <user> \[period\] \[reason\] ; us \[#chan\] <user> ; addhost <user> <host> ; delhost <user> <host>"
set black(say.en.addmanager) "add \[#chan\] <level> <user chanserv> ; adduser \[#chan\] <level> <nickname> ; userlist \[#chan]\ <level>/<all> ; info \[#chan\] <user>/<#chan> ; delacc \[#chan\] <user> ; del <user> ; auto \[#chan\] <+/-o> <user> ; auto \[#chan\] <+/-v> <user> ; chuser <user> <new user> ; s \[#chan\] <user> \[period\] \[reason\] ; us \[#chan\] <user> ; addhost <user> <host> ; delhost <user> <host>"
set black(say.en.addowner) "add \[#chan\] <level> <user chanserv> ; adduser \[#chan\] <level> <nickname> ; userlist \[#chan\] <level>/<all> ; info \[#chan\] <user>/<#chan> ; delacc \[#chan\] <user> ; del <user> ; auto \[#chan\] <+/-o> <user> ; auto \[#chan\] <+/-v> <user> ; chuser <user> <new user> ; s \[#chan\] <user> \[period\] \[reason\] ; us \[#chan\] <user> ; addhost <user> <host> ; delhost <user> <host>"
set black(say.en.addbossowner) "add \[#chan\] <level> <user chanserv> ; adduser \[#chan\] <level> <nickname> ; userlist \[#chan\] <level> ; info \[#chan\] <user>/<#chan> ; delacc \[#chan\] <user> ; del <user> ; auto \[#chan\] <+/-o> <user> ; auto \[#chan\] <+/-v> <user> ; chuser <user> <new user> ; s \[#chan\] <user> \[period\] \[reason\] ; us \[#chan\] <user> ; addhost <user> <host> ; delhost <user> <host>"
set black(say.en.addmaster) "add \[#chan\] <nivel> <user chanserv> ; adduser \[#chan\] <nivel> <nickname> ; userlist \[#chan\] <nivel> ; info \[#chan\] <user>/<#chan> ; delacc \[#chan\] <user> ; del <user> ; auto \[#chan\] <+/-o> <user> ; auto \[#chan\] <+/-v> <user> ; chuser <user> <new user> ; s \[#chan\] <user> \[period\] \[reason\] ; us \[#chan\] <user> ; addhost <user> <host> ; delhost <user> <host>"

set black(say.en.hmanager.1) "purge \[#chan\] <reason> ; set \[#chan\] <+/-option> ; set \[#chan\] <option> <description> ; unset \[#chan\] <option> ; show \[#chan\] <option> ; ignore <add>/<list>/del> \[period\] <host> ; enable <command> \[user\] ; disable <command> \[user\]"
set black(say.en.hbossowner.1) "addchan <#chan> ; delchan <#chan> ; suspend <#chan> ; unsuspend <#chan>; set \[#chan\]/\[global\] <option> <description> ; unset \[#chan\]/\[global\] <option> ; show \[#chan\] <option> ; channels ; die \[reason\] ; restart ; jump \[server\] ; save ; rehash ; nick <nick> ; uptime ; status ; cp <option> <#chan1> <#chan2> ; ignore <add>/<list>/del> \[period\] <host> ; enable <command> \[user\] \[global\] ; disable <command> \[user\] \[global\] ; chat"
set black(say.en.hmaster.1) "addchan <#chan> ; delchan <#chan> ; suspend <#chan> ; unsuspend <#chan>; set \[#chan\] <option> <description> ; unset \[#chan\] <option> ; show \[#chan\] <option> ; channels ; uptime ; status ; ignore <add>/<list>/del> \[period\] <host> ; enable <command> \[user\] \[global\] ; disable <command> \[user\] \[global\]"
set black(say.en.hchaninfo.1) "\002Eggdrop Settings\002: "
set black(say.en.hchaninfo.2) "\002BlackTools Settings\002: "
set black(say.en.hchaninfo.3) "\002Str Eggdrop\002"
...
set black(say.en.greeting.5) "\005\005\[BT\]\005\005 To get a complete list with \002available commands\002 type: \002%char%h\002 ; %botnick% h ; \002(PRIVMSG) h\002"
set black(say.en.greeting.6) "\005\005\[BT\]\005\005 To read the \002BlackToolS manual\002 of each setting use: \001%char%man <setting>\001. Have Fun! >:)"

################################## EGG ########################################

set black(say.en.egg.2) "\005\[BT\]\005 \001%msg.1%\001 is set to: \"\002%msg.8%\002\". To change it, use: \002%char%egg %msg.1%\002 <new value>"
set black(say.en.egg.3) "\005\[BT\]\005 Modified \"\001%msg.1%\001\" setting. If the change is not visible yet, use \"\002%botnick% restart\002\" or check if the value is a valid one."
set black(say.en.egg.4) "\005\[BT\]\005 There was an error. Please check if your eggdrop config exists or if \001BlackTools.tcl\001 is found in scripts directory."
set black(say.en.egg.5) "\005\[BT\]\005 You can't set \001%msg.1%\001 with \002%msg.2%\002 value. Read the \002BlackTools manual\002, by typing: \001%char%man egg\001."
set black(say.en.egg.6) "\005\[BT\]\005 You can't set \001%msg.1%\001 with \002%msg.2%\002 value. Read the \002BlackTools manual\002, by typing: \001%char%man %msg.3%\001."
set black(say.en.egg.7) "\005\[BT\]\005 \001%msg.1%\001 is set to: \"\002%msg.8%\002\". To change it, use: \002egg %msg.1%\002 <new value>"
set black(say.en.egg.8) "\005\[BT\]\005 \001%msg.1%\001 is set to: \"\002%msg.8%\002\". To change it, use: \002%botnick% egg %msg.1%\002 <new value>"
...
set black(say.en.o.1) "\005\005\[BT\]\005\005 \001%msg.1%\001 is on \002%chan%\002 you can't do massdeop."

################################### man ########################################

set black(say.en.man.1_1) "\005\005\[BT\]\005\005 Sorry \002%msg.1%\002, there is no help available for that topic."
...
set black(say.en.hello.1) "*** TAADAAA! *** You have \001%msg%\001 access level to my commands."
set black(say.en.hello.2) "\005\005\[BT\]\005\005 hi \002%msg.1%\002, I'm \004%botnick%\004, an eggdrop bot running \001%msg.2%\001 %msg.3%."
set black(say.en.hello.3) "\005\005\[BT\]\005\005 I'll recognize you by hostmask '\001%msg.1%\001' from now on. Please type \002%char%h\002 in the channel to start using this bot."
set black(say.en.hello.4) "\005\005\[BT\]\005\005 Please set your password, typing: /msg \001%botnick%\001 <pass> <yourpassword>"

##################################### Pass #####################################

set black(say.en.pass.1) "\005\005\[BT\]\005\005 Done. Your password is now: \002%msg%\002"
