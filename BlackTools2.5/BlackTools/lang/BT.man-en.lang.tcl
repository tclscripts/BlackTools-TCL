...
set black(say.en.man.27) "\[MAN\] As access \002<level>\002 you have: \002%msg.1%\002 ; \002%msg.2%\002 ; \002%msg.3%\002 ; \002%msg.4%\002 ; \002%msg.12%\002 ; \002%msg.13%\002"
...
set black(say.en.man.96) "\[MAN\] Format ban-time: \002m\002 = minutes, \002h\002 = hours, \002d\002 = days, \0020\002 = permanent"
...
set black(say.en.man.154) "\[MAN\] \002%char%banlist\002 <user / all> ; \002%botnick% banlist\002 <user / all> ; \002(PRIVMSG) banlist\002 <#chan> <user / all>"
set black(say.en.man.155) "\[MAN\] \002%char%banlist\002 <user / all> / global> ; \002%botnick% banlist\002 <user / all> / global> ; \002(PRIVMSG) banlist\002 <#chan> <user / all> / global>"
...
set black(say.en.man.208) "\[MAN\] Optional settings: \002antibadquitpart-reason\002, antibadquitpart-bantime, \002antibadquitpart-warn\002, antibadquitpart-banmethod, \002antibadquitpart-banmask\002"
...
set black(say.en.man.215) "\[MAN\] \002AntiSpam\002 protection module against users who send spam messages containing \001#\001 or \001*www.*\001."
...
set black(say.en.man.278) "\[MAN\] Optional settings: \002badident-reason\002 (default reason), \002badident-bantime\002 (default bantime)"
...
set black(say.en.man.415) "\[MAN\] Optional settings: \002badchan-reason\002, badchan-bantime, \002badchan-bmethod\002, badchan-scantime"
...
set black(say.en.man.425) "\[MAN\] \002%char%limit set <number>\002 (defaul limit number)"
...
set black(say.en.man.432) "\[MAN\] USAGE SYNTAX:"
...
set black(say.en.man.439) "\[MAN\] Optional settings: \002%char%seenreply\002 (seen output method) ; \002seenlastmsg\002"
...
set black(say.en.man.453) "\[MAN\] \002Idle\002 is a module which, when activated, will not allow users with \002op (@)\002 or \002voice (+v)\002 to idle."
set black(say.en.man.454) "\[MAN\] USAGE SYNTAXES:"
set black(say.en.man.455) "\[MAN\] \002%char%idle\002 (+/-)o ; \002%botnick% idle\002 (+/-)v ; \002(PRIVMSG) idle\002 <#chan> (+/-)o"
...
set black(say.en.man.457) "\[MAN\] Optional settings: \002idleopmax\002 <period> (default time idledeop) ; \002idlevoicemax\002 <period> (default time idlevoice)"
...
set black(say.en.man.497) "\[MAN\] Optional settings: \002next-reason\002 (default reason), \002next-bantime\002 (default bantime), \002next-backchan\002 (set backchan)"
...
set black(say.en.man.631) "\[MAN\] \002%char%ignore list\002 ; \002%char%ignore add\002 <nick / host> \[period\] \[reason\] ; \002%char%ignore del\002 <nick / host>"
...
set black(say.en.man.683) "\[MAN\] %char%say\002 <text> ; \002%botnick% say\002 <text> ; \002(PRIVMSG) say\002 <#chan> <text>"
...
set black(say.en.man.820) "\[MAN\] \002VoiceMe\002 is a module which, once activated, will give users logged with \002*X*\002, the ability to have \002voice (+v)\002 simply using command \002/msg %botnick% voiceme <#chan>\002 (see also \002%char%man onlyonmode\002)."
...
set black(say.en.man.851) "\[MAN\] \002Troll\002 bans a user with a default \002TROLL\002 reason."
set black(say.en.man.852) "\[MAN\] Also, once activated, the eggdrop will display a message list of current day trolls when users join the channel (the list is reset everyday at midnight)."
set black(say.en.man.853) "\[MAN\] USAGE SYNTAX:"
set black(say.en.man.854) "\[MAN\] \002%char%troll\002 <nick> ; \002%botnick% troll\002 <nick> ; \002(PRIVMSG) troll\002 <#chan> <nick>"
set black(say.en.man.855) "\[MAN\] Optional settings: \002%char%set\002 troll-reason <text>; \002(PRIVMSG) set\002 <#chan> troll-reason <text> (default reason)"
...
set black(say.en.man.875) "\[MAN\] \002lang\002 <language> ; \002output\002 <method> ; \002mychar\002 <trigger> ; \002colors\002 <colors> ; \002noteexpire\002 <no. days> ; \002autoinvite\002 <ON/OFF>"
...
set black(say.en.man.884_5) "\[MAN\] \002%char%ho +\002 (masshalfop) ; \002%char%ho -\002 (masshalfdeop)"
...
set black(say.en.man.900) "View options settings: \002%char%show\002 <setting> ; \002%botnick% show\002 <setting> ; \002(PRIVMSG) show\002 <#chan> <setting>"
...
set black(say.en.man.923) "\[MAN\] \002%char%timer\002 start \[#chan\] <timer:setting> ; \002%char%timer\002 kill \[#chan\] <pid timer> (from list) ; \002%char%timer\002 \[#chan\] list"
...
set black(say.en.man.979) "\[MAN\] \002%char%myset\002 noteexpire <no. days> ; \002%botnick% myset\002 mychan <no. days> ; \002(PRIVMSG) myset\002 mychan <no. days>"
...
set black(say.en.man.987) "\[MAN\] \002MyChar\002 allows each user to choose and set a default \002trigger\002 (from allowed triggers list) to which they want the eggdrop to react to."
...
set black(say.en.man.1137) "\[MAN\] \002%char%egg user-expire\002 <days> ; \002%botnick% egg user-expire\002 <days> ; \002(PRIVMSG) egg user-expire\002 <days>"
