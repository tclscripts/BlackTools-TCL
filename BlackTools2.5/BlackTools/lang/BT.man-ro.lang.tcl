...
set black(say.ro.man.3) "\[MAN\] \002Man\002 este o comanda ce permite vizualizarea manualului BlackTools."
...
set black(say.ro.man.10) "\[MAN\] Pentru a vizualiza meniul principal foloseste: \002%char%h\002 ; %botnick% h ; \002(PRIVMSG) h\002 \[#canal\]"
...
set black(say.ro.man.15) "\[MAN\] \002%char%v +\002 (massvoice) ; \002%char%v -\002 (massdevoice)"
...
set black(say.ro.man.20) "\[MAN\] \002%char%o +\002 (massop)\002 ; %char%o -\002 (massdeop)"

#UserList

set black(say.ro.man.22) "\[MAN\] \002UserList\002 este o comanda prin care puteti vizualiza lista userilor cu acces de pe un anumit canal."
...
set black(say.ro.man.27) "\[MAN\] Ca \002<nivel>\002 de access avem: \002%msg.1%\002 ; \002%msg.2%\002 ; \002%msg.3%\002 ; \002%msg.4%\002 ; \002%msg.12%\002 ; \002%msg.13%\002"
set black(say.ro.man.28) "\[MAN\] Ca \002<nivel>\002 de access avem: \002%msg.1%\002 ; \002%msg.2%\002 ; \002%msg.3%\002"
...
set black(say.ro.man.31) "\[MAN\] \002Info\002 este o comanda prin care puteti vizualiza informatii despre useri/canale."
set black(say.ro.man.32) "\[MAN\] Aceasta afiseaza informatii precum nivelul de acces, modurile unui canal, mesajul de intampinare, hostmask-urile userilor, etc."
set black(say.ro.man.33) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.34) "\[MAN\] \002%char%info\002 <user / #canal> ; \002%botnick% info\002 <user / #canal> ; \002(PRIVMSG) info\002 <user / #canal>"
...
set black(say.ro.man.37) "\[MAN\] \002%char%act\002 <text> ; \002%botnick% act\002 <text> ; \002(PRIVMSG) act\002 <#canal> <text>"
...
set black(say.ro.man.40) "\[MAN\] \002%char%t\002 <text> ; \002%botnick% t\002 <text> ; \002(PRIVMSG) t\002 <#canal> <text>"
...
set black(say.ro.man.44) "\[MAN\] \002%char%cycle\002 \[timp / motiv\] ; \002%botnick% cycle\002 \[timp / motiv\] ; \002(PRIVMSG) cycle\002 <#canal> \[timp / motiv\]"

#Mode

set black(say.ro.man.45) "\[MAN\] \002Mode\002 este o comanda prin care eggdrop-ul va seta unul sau mai multe \002moduri\002 pe un anumit canal."
...
set black(say.ro.man.62) "\[MAN\] \002k\002 este o comanda care care puteti da kick unui user de pe canal. Motivul este optional."
set black(say.ro.man.63) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.64) "\[MAN\] \002%char%k\002 <nick> \[motiv\] ; \002%botnick% k\002 <nick> \[motiv\] ; \002(PRIVMSG) k\002 <#canal> <nick> \[motiv\]"
...
set black(say.ro.man.73) "\[MAN\] Setari optionale: \002%char%set\002 check-message <text> ; \002(PRIVMSG) set\002 check-message <text> (setare mesaj verificare predefinit)"
...
set black(say.ro.man.76) "\[MAN\] \002%char%sb\002 <host / nick> ; \002%botnick% sb\002 <*host* / nick> ; \002(PRIVMSG) sb\002 <#canal> <*host* / nick>"
set black(say.ro.man.77) "\[MAN\] \002%char%sb\002 <host / nick> \[global\] ; \002%botnick% sb\002 <*host* / nick> \[global\] ; \002(PRIVMSG) sb\002 <#canal> <*host* / nick> \[global\]"
...
set black(say.ro.man.86) "\[MAN\] Setari optionale: \002n-reason\002 (setare motiv predefinit); \002n-bantime\002 (setare timp ban in minute)"
...
set black(say.ro.man.93) "\[MAN\] \002%char%dr <nick1>,<nick2>/<host1>,<host2> ; %botnick% dr <nick1>,<nick2>/<host1>,<host2> ; (PRIVMSG) dr <#canal> <nick1>,<nick2>/<host1>,<host2>\002"
...
set black(say.ro.man.95) "\[MAN\] \002b\002 este o comanda prin care se poate da ban unui user cu un motiv si un ban-time predefinit. Daca specificati perioada \0020\002 banul devine permanent (blacklisted)."
set black(say.ro.man.96) "\[MAN\] Format ban-time: \002m\002 = minute, \002h\002 = ore, \002d\002 = zile, \0020\002 = permanent"
set black(say.ro.man.97) "\[MAN\] SINTAXE FOLOSIRE:"
set black(say.ro.man.98) "\[MAN\] \002%char%b\002 <nick / host> \[-nivel\] \[timp\] \[motiv\] ; \002%botnick% b\002 <nick / host> \[-nivel\] \[timp\] \[motiv\] ; \002(PRIVMSG) b\002 <#canal> <nick / host> \[-nivel\] \[timp\] \[motiv\]"
set black(say.ro.man.99) "\[MAN\] \002%char%b\002 <nick / host> \[-nivel\] \[timp\] \[global\] \[motiv\] ; \002%botnick% b\002 <nick / host> \[-nivel\] \[timp\] \[global\] \[motiv\] ; \002(PRIVMSG) b\002 <#canal> <nick / host> \[-nivel\] \[timp\] \[global\] \[motiv\]"
...
set black(say.ro.man.104) "\[MAN\] \002%char%ub\002 <nick / *host* / id> \[global\]\002 ; \002%botnick% ub\002 <nick / *host* / id> \[global\] ; \002(PRIVMSG) ub\002 <#canal> <nick / *host* / id> \[global\]"
...
set black(say.ro.man.114) "\[MAN\] \002Black\002 este o comanda prin care se poate da ban unui user cu un motiv dat pe o perioada \002NELIMITATA\002 (ban permanent)."
...
set black(say.ro.man.118) "\[MAN\] \002Stick\002 este o comanda prin care se poate da ban de tip \sticky\ unuia sau mai multor useri cu motiv dat si perioada data. Acest ban va fi mentinut mereu in lista de ban-uri a canalului."
set black(say.ro.man.119) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.120) "\[MAN\] \002%char%stick\002 <nick / host> \[timp\] \[motiv\] ; %botnick% stick\002 <nick / host> \[timp\] \[motiv\] ; \002(PRIVMSG) stick\002 <#canal> <nick / host> \[timp\] \[motiv\]"
...
set black(say.ro.man.122) "\[MAN\] \002Gag\002 este o comanda prin care se poate reduce la tacere un user pe o anumita perioada timp (acesta numai poate tasta pe canal)."
set black(say.ro.man.123) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.124) "\[MAN\] \002%char%gag\002 <nick> \[timp\] \[motiv\] ; \002%botnick% gag\002 <nick> \[timp\] \[motiv\] ; \002(PRIVMSG) gag\002 <#canal> <nick> \[timp\] \[motiv\]\002."
...
set black(say.ro.man.126) "\[MAN\] \002Add\002 este o comanda prin care se adauga access unui user. Ca user se foloseste userul de la \002%msg.1%\002, iar hostul adaugat automat pentru acest user va fi: \002%msg.2%\002"
set black(say.ro.man.127) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.128) "\[MAN\] \002%char%add\002 <nivel> <user> ; \002%botnick% add\002 <nivel> <user> ; \002(PRIVMSG) add\002 <#canal> <nivel> <user>"

#Adduser

set black(say.ro.man.134) "\[MAN\] \002Adduser\002 reprezinta o comanda prin care se adauga access unui user. Ca user se foloseste \002NICK-ul\002, iar hostul adaugat automat pentru acest user va fi cel curent adica cel luat de pe IRC."
set black(say.ro.man.135) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.136) "\[MAN\] \002%char%adduser\002 <nivel> <nick> ; \002%botnick% adduser\002 <nivel> <nick> ; \002(PRIVMSG) adduser\002 <#canal> <nivel> <nick>"

#DelAcc

set black(say.ro.man.142) "\[MAN\] \002DelAcc\002 este o comanda prin care se sterge accesul unui user de pe un anumit canal."
set black(say.ro.man.142_1) "\[MAN\] \002RETINETI\002: pentru a sterge accesul unui user din lista unui canal, atunci nivelul tau de acces trebuie sa fie mai mare decat nivelul de acces al userului respectiv (deci, daca tu ai acces de \002OP\002, iar userul respectv are \002ADMIN\002 atunci nu ii poti sterge accesul)."
set black(say.ro.man.143) "\[MAN\] SINTAXE FOLOSIRE:"
set black(say.ro.man.144) "\[MAN\] \002%char%delacc\002 <user> ; %botnick% delacc\002 <user> ; \002(PRIVMSG) delacc\002 <#canal> <user>"
set black(say.ro.man.145) "\[MAN\] \002%char%delacc\002 <owner / master> <user> ; \002%botnick% delacc\002 <owner / master> <user> ; \002(PRIVMSG) delacc\002 <#canal> <owner / master> <user> (stergere access global)"

#Del

set black(say.ro.man.146) "\[MAN\] \002Del\002 este o comanda prin care se sterge un user din memoria eggdrop-ului."
set black(say.ro.man.147) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.148) "\[MAN\] \002%char%del\002 <user> ; \002%botnick% del\002 <user> ; \002(PRIVMSG) del\002 <#canal> <user>"
...
set black(say.ro.man.154) "\[MAN\] \002%char%banlist\002 <user / all> ; \002%botnick% banlist\002 <user / all> ; \002(PRIVMSG) banlist\002 <#canal> <user / all>"
set black(say.ro.man.155) "\[MAN\] \002%char%banlist\002 <user / all> / global> ; \002%botnick% banlist\002 <user / all> / global> ; \002(PRIVMSG) banlist\002 <#canal> <user / all> / global>"
...
set black(say.ro.man.158) "\[MAN\] \002%char%addhost\002 <user> <host> ; \002%botnick% addhost\002 <user> <host> ; \002(PRIVMSG) addhost\002 <#canal> <user> <host>"
...
set black(say.ro.man.161) "\[MAN\] \002%char%delhost\002 <user> <host> ; \002%botnick% delhost\002 <user> <host> ; \002(PRIVMSG) delhost\002 <#canal> <user> <host>"
...
set black(say.ro.man.170) "\[MAN\] \002%char%us\002 <user> ; \002%botnick% us\002 <user> ; \002(PRIVMSG) us\002 <#canal> <user>"

#Auto

set black(say.ro.man.171) "\[MAN\] \002Auto\002 este o comanda prin care se acorda autoop/autovoice unui anumit user."
set black(say.ro.man.172) "\[MAN\] SINTAXE FOLOSIRE:"
set black(say.ro.man.173) "\[MAN\] AutoVOICE: \002%char%auto (+/-)v\002 <user> ; %botnick% auto (+/-)v <user> ; \002(PRIVMSG) auto\002 <#canal> (+/-)v <user>"
set black(say.ro.man.174) "\[MAN\] AutoOP: \002%char%auto (+/-)o\002 <user> ; %botnick% auto (+/-)o <user> ; \002(PRIVMSG) auto\002 <#canal> (+/-)o <user>"
set black(say.ro.man.175) "\[MAN\] AutoVOICE: \002%char%auto (+/-)v\002 <user> \[-global\] ; %botnick% auto\002 (+/-)v <user> \[-global\] ; \002(PRIVMSG) auto\002 <#canal> (+/-)v <user> \[-global\]"
set black(say.ro.man.176) "\[MAN\] AutoOP: \002%char%auto (+/-)o\002 <user> \[-global\] ; %botnick% auto\002 (+/-)o <user> \[-global\] ; \002(PRIVMSG) auto\002 <#canal> (+/-)o <user> \[-global\]"
...
set black(say.ro.man.177) "\[MAN\] \002AntiPub\002 este un modul de protectie impotriva userilor ce fac reclama de tipul \"#\" sau \"www.*\""
...
set black(say.ro.man.180) "\[MAN\] \002%char%antipub\002 add \[#canal\] <*link* / #*canal*> ; \002%char%antipub\002 list ; \002%char%antipub\002 del <nr list>"
...
set black(say.ro.man.193) "\[MAN\] \002AntiBadWord\002 este un modul de protectie impotriva userilor ce folosesc anumite cuvinte/fraze *interzise* pe %chan%."
...
set black(say.ro.man.196) "\[MAN\] \002%char%badword add\002 \[#canal\] <*cuvant*/ *fraza*> ; \002%char%badword list\002 ; \002%char%badword del\002 <nr list>"
set black(say.ro.man.197) "\[MAN\] Setari optionale: \002antibadword-reason\002, antibadword-bantime, \002antibadword-warn\002, antibadword-banmethod, \002antibadword-banmask\002"
set black(say.ro.man.198) "Vizualizare setari optiuni: \002%char%show\002 <setare> ; \002%botnick% show\002 <setare> ; \002(PRIVMSG) show\002 <#canal> <setare>"
...
set black(say.ro.man.204) "\[MAN\] \002AntiBadQuitPart\002 este un modul de protectie impotriva userilor ce parasesc %chan% utilizand  cuvinte *interzise* in mesajul de /part sau /quit."
...
set black(say.ro.man.207) "\[MAN\] \002%char%badquitpart add\002 \[#canal\] <*text*> ; \002%char%badquitpart\002 list ; \002%char%badquitpart del\002 <nr list>"
set black(say.ro.man.208) "\[MAN\] Setari optionale: \002antibadquitpart-reason\002, antibadquitpart-bantime, \002antibadquitpart-warn\002, antibadquitpart-banmethod, \002antibadquitpart-banmask\002"
set black(say.ro.man.209) "Vizualizare setari optiuni: \002%char%show\002 <setare> ; \002%botnick% show\002 <setare> ; \002(PRIVMSG) show\002 <#canal> <setare>"
...
set black(say.ro.man.215) "\[MAN\] \002AntiSpam\002 este un modul de protectie impotriva userilor ce fac spam prin mesaje catre eggdrop continand \001#\001 sau \001*www.*\001"
...
set black(say.ro.man.218) "\[MAN\] \002%char%antispam add\002 \[#canal\] <*text*> ; \002%char%antispam list\002 ; \002%char%antispam del\002 <nr list>"
set black(say.ro.man.219) "\[MAN\] Setari optionale: \002antispam-reason\002, antispam-message, \002antispam-bantime\002, antispam-banmask, \002antispam-cycletime\002"
set black(say.ro.man.220) "Vizualizare setari optiuni: \002%char%show\002 <setare> ; \002%botnick% show\002 <setare> ; \002(PRIVMSG) show\002 <#canal> <setare>"
...
set black(say.ro.man.224) "\[MAN\] Setari optionale: \002antirepeat-reason\002, antirepeat-bantime, \002antirepeat-warn\002, antirepeat-banmethod, \002antirepeat-banmask\002"
...
set black(say.ro.man.249) "\[MAN\] \002%char%badnick add\002 \[#canal\] <*text*> ; \002%char%badnick list\002 ; \002%char%badnick del\002 <nr list>"
set black(say.ro.man.250) "\[MAN\] Setari optionale: \002badnick-reason\002, badnick-bantime, \002badnick-banmask\002"
set black(say.ro.man.251) "Vizualizare setari optiuni: \002%char%show\002 <setare> ; \002%botnick% show\002 <setare> ; \002(PRIVMSG) show\002 <#canal> <setare>"

#BadRealname

set black(say.ro.man.252) "\[MAN\] \002BadRealname\002 este un modul de protectie impotriva userilor ce folosesc realname-uri ce au in componenta caractere *interzise*."
...
set black(say.ro.man.255) "\[MAN\] \002%char%badrealname add\002 \[#canal\] <*text*> ; \002%char%badrealname list\002 ; \002%char%badrealname del\002 <nr list>"
set black(say.ro.man.256) "\[MAN\] Setari optionale: \002badrealname-reason\002, badrealname-bantime, \002badrealname-banmask\002"
set black(say.ro.man.257) "Vizualizare setari optiuni: \002%char%show\002 <setare> ; \002%botnick% show\002 <setare> ; \002(PRIVMSG) show\002 <#canal> <setare>"
...
set black(say.ro.man.264) "\[MAN\] \002AntiJoinFlood\002 este un modul de protectie impotriva actiunii de \002massjoin\002 prin blocarea canalului cu moduri."
...
set black(say.ro.man.267) "\[MAN\] Setari optionale: \002joinflood\002 (<numar joins>:<nr secunde>)"
...
set black(say.ro.man.272) "\[MAN\] Setari optionale: \002antichanflood-reason\002 (setare motiv predefinit), \002antichanflood-bantime\002 (setare timp ban predefinit), \002chanflood\002 (<numar linii>:<nr secunde>)"
...
set black(say.ro.man.274) "\[MAN\] \002BadIdent\002 este un modul de protectie impotriva userilor ce folosesc IDENT-uri ce au in componenta caractere *interzise*."
...
set black(say.ro.man.277) "\[MAN\] \002%char%badident add\002 \[#canal\] <*text*> ; \002%char%badident list\002 ; \002%char%badident del\002 <nr list>"
set black(say.ro.man.278) "\[MAN\] Setari optionale: \002badident-reason\002 (setare motiv predefinit), \002badident-bantime\002 (setare timp ban predefinit)"
set black(say.ro.man.279) "Vizualizare setari optiuni: \002%char%show\002 <setare> ; \002%botnick% show\002 <setare> ; \002(PRIVMSG) show\002 <#canal> <setare>"
...
set black(say.ro.man.308) "\[MAN\] USAGE SYNTAX:"
...
set black(say.ro.man.413) "\[MAN\] \002%char%badchan add\002 <#*canal*> \[motiv\] ; \002%char%badchan del\002 <nr list> ; \002%char%badchan list\002"
set black(say.ro.man.414) "\[MAN\] \002%char%badchan add\002 <#*canal*> \[-global\] \[motiv\]\002 ; %char%badchan del\002 <nr list> \[-global\] ; \002%char%badchan list\002 \[-global\]"
set black(say.ro.man.415) "\[MAN\] Setari optionale: \002badchan-reason\002, badchan-bantime, \002badchan-bmethod\002, badchan-scantime"
set black(say.ro.man.416) "Vizualizare setari optiuni: \002%char%show\002 <setare> ; \002%botnick% show\002 <setare> ; \002(PRIVMSG) show\002 <#canal> <setare>"

#Anunt

set black(say.ro.man.417) "\[MAN\] \002Anunt\002 este un modul care va avea rolul de a afisa anunturi pe %chan% la un anumit interval de timp."
...
set black(say.ro.man.420) "\[MAN\] \002%char%anunt add\002 \[#canal\] <mesaj> ; \002%char%anunt list\002 ; \002%char%anunt del\002 <nr list>"
set black(say.ro.man.421) "\[MAN\] Pentru a adauga mai mult de 1 propozitie intr-un anunt folositi \002%char%anunt add <anunt1>~<anunt2>..\002 iar eggdrop-ul va da anuntul ca doua propozitii diferite."
...
set black(say.ro.man.425) "\[MAN\] \002%char%limit set <numar>\002 (setare valoare pentru limita)"
...
set black(say.ro.man.429) "\[MAN\] \002%char%topic\002 set \[#canal\] <text> ; \002%botnick% topic\002 set \[#canal\] <text> ; \002(PRIVMSG) topic\002 set \[#canal\] <text>"
set black(say.ro.man.430) "\[MAN\] Setare optiuni: \002%char%set\002 <setare> <text / numar> ; \002%botnick% set\002 <setare> <text / numar> ; \002(PRIVMSG) set\002 <#canal> <setare> <text / numar>"
...
set black(say.ro.man.432) "\[MAN\] SINTAXA FOLOSIRE:"
...
set black(say.ro.man.436) "\[MAN\] \002Seen\002 este un modul care odata activat va salva inregistrari cu join/part/quit/netsplit/nickchange a userilor de pe acel canal. Are o baza de date pentru fiecare canal."
set black(say.ro.man.437) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.438) "\[MAN\] \002%char%set\002 (+/-)seen ; \002%botnick% set\002 (+/-)seen ; \002(PRIVMSG) set\002 <#canal> (+/-)seen"
set black(say.ro.man.439) "\[MAN\] Setari optionale: \002seenreply\002 (metoda de iesire) ; \002seenlastmsg\002"
...
set black(say.ro.man.441) "\[MAN\] \002Greet\002 este un modul prin care puteti adauga un mesaj de intampinare catre userii care dau join pe %chan% (vezi si %char%man infoline)."
...
set black(say.ro.man.444) "\[MAN\] \002%char%greet set\002 \[#canal\] <mesaj>\002 ; \002%botnick% greet set\002 greet <mesaj> ; \002(PRIVMSG) greet set\002 <mesaj>"
set black(say.ro.man.445) "\[MAN\] Setari optionale: \002%char%set greet-method <metoda>\002 (NOTICE | PRIVMSG)"
set black(say.ro.man.446) "\[MAN\] Pentru a adauga mai mult de 1 propozitie intr-un greet folositi \002%char%set \[#canal\] greet <greet1>~<greet2>..\002 iar eggdrop-ul va da greet-ul ca doua propozitii diferite."
...
set black(say.ro.man.450) "\[MAN\] \002%char%leave set\002 \[#canal\] <mesaj>\002 ; \002%botnick% leave set\002 \[#canal\] <mesaj> ; \002(PRIVMSG) leave set\002 \[#canal\] <mesaj>"
set black(say.ro.man.451) "\[MAN\] Setari optionale: \002%char%set leave-method <metoda>\002 (NOTICE | PRIVMSG)"
set black(say.ro.man.452) "\[MAN\] Pentru a adauga mai mult de 1 propozitie intr-un greet folositi \002%char%set \[#canal\] leave <leave1>~<leave2>..\002 iar eggdrop-ul va da leave-ul ca doua propozitii diferite."
...
set black(say.ro.man.455) "\[MAN\] \002%char%idle\002 <(+/-)o / (+/-)v> ; \002%botnick% idle\002 <(+/-)o / (+/-)v> ; \002(PRIVMSG) idle\002 <#canal> <(+/-)o / (+/-)v>"
...
set black(say.ro.man.457) "\[MAN\] Setari optionale: \002%char%set\002 idleopmax <timp> ; \002%char%set\002 idlevoicemax <timp>"
...
set black(say.ro.man.459) "\[MAN\] \002BackChan\002 (fostul ChanReport) este un modul care odata activat da posibilitatea ca un anumit canal sa aibe un backchan in care eggdrop-ul va anunta banurile date de catre acesta pe canalul principal."
...
set black(say.ro.man.462) "\[MAN\] Odata cu setarea canalului \002backchan\002 puteti folosi pe acesta toate comenzile de ban, iar acestea vor fi aplicate pe \002<#canal>\002 (canalul principal)."
...
set black(say.ro.man.467) "\[MAN\] \002%char%topwords\002 ; \002%char%topwords\002 total ; \002%char%topwords\002 reset (resetare top cuvinte)"
...
set black(say.ro.man.485) "\[MAN\] \002%char%bt add\002 <mesaj> ; \002%char%bt\002 list ; \002%char%bt del\002 <nr list>"
...
set black(say.ro.man.487) "\[MAN\] \002Language\002 (lang) este o comanda prin care se poate seta limba default in care vei primi mesajele de la eggdrop, cat si limba default a motivelor de kick/ban de pe un anumit canal."
set black(say.ro.man.487_1) "\[MAN\] \002Lang\002 (language) este o comanda prin care se poate seta limba default in care vei primi mesajele de la eggdrop, cat si limba default a motivelor de kick/ban de pe un anumit canal."
...
set black(say.ro.man.490) "\[MAN\] \002TCL\002 este un modul cu care puteti incarca tcl-uri, lista atat cele incarcate cat si cele din scripts"
set black(say.ro.man.491) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.492) "\[MAN\] \002%char%tcl <list>\002 (vizualizare tcl-uri incarcate); %char%tcl wget <link.tcl>; \002%char%tcl load\002 <nume.tcl> (incarcare tcl); \002%char%tcl \002unload\002 <nume.tcl> (dezactivare tcl); \002%char%tcl all\002 (vizualizare tcluri); \002%char%tcl info\002 <nume.tcl> (informatii tcl) "
...
set black(say.ro.man.497) "\[MAN\] Setari optionale: \002next-reason\002 (setare motiv predefinit), \002next-bantime\002 (setare timp ban in minute), \002next-backchan\002 (setare backchan)"
...
set black(say.ro.man.611) "\[MAN\] \002Set\002 este o comanda prin care puteti seta orice optiuni ale eggdrop-ului (flaguri)."
set black(say.ro.man.612) "\[MAN\] SINTAXE FOLOSIRE:"
set black(say.ro.man.613) "\[MAN\] \002%char%set\002 (+/-)flag / <flag> <optiune> <descriere> ; \002%botnick% set\002 (+/-)flag / <flag> <optiune> <descriere> ; \002(PRIVMSG) set\002 <#canal> (+/-)flag / <flag> <optiune> <descriere>"
set black(say.ro.man.614) "\[MAN\] \002%char%set\002 global (+/-)flag / <flag> <optiune> <descriere> (setare pentru toate canalele)"
...
set black(say.ro.man.625) "\[MAN\] \002 %char%msg\002 <nick> <text> ; \002%botnick% msg\002 <nick> <text> ; \002(PRIVMSG) msg\002 <nick> <text>"
...
set black(say.ro.man.628) "\[MAN\] \002 %char%broadcast\002 <text> ; \002%botnick% broadcast\002 <text> ; \002(PRIVMSG) broadcast\002 <text>"
...
set black(say.ro.man.631) "\[MAN\] \002%char%ignore list\002 ; \002%char%ignore add\002 <nick / host> \[timp\] \[motiv\] ; \002%char%ignore del\002 <nick / host>"
...
set black(say.ro.man.643_1) "\[MAN\] \002%char%nick egg\002 <nicknou> ; \002%botnick% egg nick\002 <nicknou> ; \002(PRIVMSG) egg nick\002 <nicknou> (setare permanenta)"
...
set black(say.ro.man.653) "\[MAN\] \002%char%die\002 ; %botnick% nick die ; \002(PRIVMSG) die\002"
...
set black(say.ro.man.683) "\[MAN\] %char%say\002 <text> ; \002%botnick% say\002 <text> ; \002(PRIVMSG) say\002 <#canal> <text>"

#Refresh

set black(say.en.man.684) "\[MAN\] \002Topicrefresh\002 ajuta la mentinerea topicului de pe %chan% prin reaplicarea lui la un interval de timp."
set black(say.en.man.685) "\[MAN\] USAGE SYNTAX:"
set black(say.en.man.686) "\[MAN\] \002%char%set\002 (+/-)refresh | \002%botnick% set\002 (+/-)refresh ; \002(PRIVMSG) set\002 <#canal> (+/-)refresh"
...
set black(say.ro.man.787) "\[MAN\] \002%char%badhost add\002 <*bad ip* / *bad vhost*>\002 ; \002%char%badhost del\002 <nr list> ; \002%char%badhost list\002"
...
set black(say.ro.man.797) "\[MAN\] \002%char%securemode add\002 <*ip* / *host*> (suporta wildcard-uri) ; \002%char%securemode del\002 <nr list> ; \002%char%securemode list\002"
...
set black(say.ro.man.842) "\[MAN\] \002cp\002 este un modul care permite copierea setarilor unui canal pe alt canal, incluzand atat userii cu access, cat si lista de banuri sau setarile canalului."
...
set black(say.ro.man.845) "\[MAN\] Ca \002<optiuni>\002 avem: \002<userlist>\002 (copiaza userlist-ul canalului); \002<banlist>\002 (copiaza banlist-ul canalului); \002<settings>\002 (copiaza setarile canalului)"
...
set black(say.ro.man.847) "\[MAN\] Totodata, le va lua acel voice (-v) utilizatorilor inactivi, cei cu un idle mai mare decat intervalul de timp predefinit."
...
set black(say.ro.man.850) "\[MAN\] Setari optionale: \002%char%set voiceonmsg-linenum\002 <nr linii> (setare linii default) ; \002%char%set voiceonmsg-idletime\002 <timp> (setare interval idle default)"

#Troll

set black(say.ro.man.851) "\[MAN\] \002Troll\002 este o comanda prin care un utilizator sau mai multi vor primi ban cu un motiv implicit de \002troll\002."
set black(say.ro.man.852) "\[MAN\] De asemenea, odata activat va face ca eggdrop-ul sa afiseze, la join, o lista cu trollii zilei curente (lista se reseteaza in fiecare zi la orele 24:00)."
set black(say.ro.man.853) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.854) "\[MAN\] \002%char%troll\002 <nick> ; \002%botnick% troll\002 <nick> ; \002(PRIVMSG) troll\002 <#canal> <nick>"
set black(say.ro.man.855) "\[MAN\] Setari optionale: \002%char%set\002 troll-reason (motiv ban default) ; \002(PRIVMSG) set\002 <#canal> troll-reason (motiv ban default)"
...
set black(say.ro.man.873) "\[MAN\] \002%char%myset\002 <optiune> \[descriere\] <reset / show> ; \002(PRIVMSG) myset\002 <optiune> \[descriere\] <reset / show>"
...
set black(say.ro.man.878) "\[MAN\] \002auto\002 (+/-)v/o \[-global\] (AUTOMODE OP/VOICE) ; \002addhost/delhost\002 <host> ; \002handle\002 <handle nou> ; \002greet\002 <mesaj personal de intampinare> ; \002mychan\002 <#canal>"
...
set black(say.ro.man.884_5) "\[MAN\] \002%char%ho +\002 (masshalfop) ; \002%char%ho -\002 (masshalfdeop)"
...
set black(say.ro.man.895) "\[MAN\] \002%char%q\002 \[#canal\] <fraza> (adaugare quote) ; \002%char%q\002 \[#canal\] <cuvant> (cauta quote) ; \002%char%q\002 \[#canal\] <list> ; \002%char%q\002 \[#canal\] del <nr quote>"
set black(say.ro.man.896) "\[MAN\] Pentru a adauga mai mult de o propozitie utilizati: \002%char%q add \[#canal\] <text1>~<text2>..\002 si eggdrop-ul va arata nota ca 2 propozitii diferite."
...
set black(say.ro.man.900) "\[MAN\] Setari optionale: \002%char%set\002 quoteofday-showtime <timp> ; \002(PRIVMSG) set\002 <#canal> quoteofday-showtime <timp> (m =minute, h = ore, d = zile)"
...
set black(say.ro.man.904) "\[MAN\] \002%char%note\002 send <user> <text> ; \002%char%note\002 <read / list> ; \002%char%note\002 del <nr nota / all>"
set black(say.ro.man.905) "\[MAN\] Pentru a adauga mai mult de o propozitie utilizati: \002%char%note send <user> <text1>~<text2>\002.. si eggdrop-ul va arata nota ca 2 propozitii diferite."
...
set black(say.ro.man.923) "\[MAN\] \002%char%timer\002 start \[#canal\] <timer:setare> ; \002%char%timer\002 kill <#canal> <nr timer> (din lista) ; \002%char%timer\002 \[#canal\] list"

#Enable

set black(say.ro.man.924) "\[MAN\] \002Enable\002 este o comanda prin care se ACTIVEAZA o comanda dezactivata cu disable. Daca este folosita optiunea \"global\", comanda va fi activata pe toate canalele eggdrop-ului."
set black(say.ro.man.925) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.926) "\[MAN\] %char%enable\002 \[#canal\] <comanda / all> \[-global\] ; \002(PRIVMSG) enable\002 <#canal> <comanda / all> \[-global\]"

#Disable

set black(say.ro.man.927) "\[MAN\] \002Disable\002 este o comanda prin care se DEZACTIVEAZA o comanda anume. Daca este folosita optiunea \"global\", comanda va fi dezactivata pe toate canalele eggdrop-ului."
set black(say.ro.man.928) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.929) "\[MAN\] %char%disable\002 \[#canal\] <comanda / all> \[-global\] ; \002(PRIVMSG) disable\002 <#canal> <comanda / all> \[-global\]"

#Activ

set black(say.ro.man.930) "\[MAN\] \002Activ\002 este o comanda folosita pentru a afisa informatii despre un anumit ban sau pentru a afla activitatea unui user cu acces (banstats, wordstats, etc.)."
set black(say.ro.man.931) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.932) "\[MAN\] %char%activ\002 \[#canal>\] <user> ; \002%botnick% activ\002 \[#canal>\] <user> ; \002(PRIVMSG) activ\002 <#canal> <user>"
...
set black(say.ro.man.938) "\[MAN\] \002%char%myset greet\002 <text / reset> ; \002%botnick% myset\002 greet <text / reset> ; \002(PRIVMSG) myset greet\002 <text / reset>  (\002reset\002 sterge mesajul de intampinare)"
...
set black(say.ro.man.941) "\[MAN\] %char%unset\002 <flag / str / optiune> ; \002%botnick% unset\002 <flag / optiune / str> ; \002(PRIVMSG) unset\002 <#canal> <flag / str / optiune >"
...
set black(say.ro.man.971) "\[MAN\] \002%char%set\002 antispam-message <text> ; \002%botnick% set\002 antispam-message <text> ; \002(PRIVMSG) set\002 <#canal> <text> (mesaj join predefinit)"
...
set black(say.ro.man.979) "\[MAN\] \002%char%myset\002 noteexpire <nr. zile> ; \002%botnick% myset\002 mychan <nr. zile> ; \002(PRIVMSG) myset\002 mychan <nr. zile>"
...
set black(say.ro.man.983) "\[MAN\] \002Invisible\002 va ascunde un anumit canal; asta inseamna ca acel canal nu va mai aparea in lista de canale ale eggdrop-ului."
...
set black(say.ro.man.987) "\[MAN\] \002MyChar\002 permite fiecarui utilizator sa isi aleaga si sa-si seteze un \002trigger\002 implicit (din lista de triggere permise) la care vor ca eggdrop-ul sa reactioneze (sa raspunda la comenzi)."
...
set black(say.ro.man.996) "\[MAN\] \002%char%egg cmdchar\002 <trigger1 trigger2 ..> ; \002%botnick% egg cmdchar\002 <trigger1 trigger2 ..> ; \002(PRIVMSG) egg cmdchar\002 <trigger1 trigger2 ..>"
...
set black(say.ro.man.1100) "\[MAN\] \002%char%egg defaultlang\002 <limba> ; \002%botnick% egg defaultlang\002 <limba> ; \002(PRIVMSG) egg defaultlang\002 <limba>"
...
set black(say.ro.man.1105) "\[MAN\] \002%char%egg homechan\002 <#canal> ; \002%botnick% egg homechan\002 <#canal> ; \002(PRIVMSG) egg homechan\002 <#canal>"
...
set black(say.ro.man.1109) "\[MAN\] \002%char%egg realname\002 <text> ; \002%botnick% egg realname\002 <text> ; \002(PRIVMSG) egg realname\002 <text>"
...
set black(say.ro.man.1113) "\[MAN\] \002%char%egg away\002 <mesaj away> ; \002%botnick% egg away\002 <mesaj away> ; \002(PRIVMSG) egg away\002 <mesaj away>"
set black(say.ro.man.1113_1) "\[MAN\] \002 %char%egg away\002 OFF ; \002%botnick% egg away\002 OFF> ; \002(PRIVMSG) egg away\002 OFF (dezactivare away)"
...
set black(say.ro.man.1117) "\[MAN\] \002%char%egg defaultoutput\002 <metoda> ( CHAN | NOTICE | PRIVMSG ) ; \002(PRIVMSG) egg defaultoutput\002 <metoda> ( CHAN | NOTICE | PRIVMSG )"
...
set black(say.ro.man.1121) "\[MAN\] \002%char%egg floodmenuprot\002 <nr comenzi:secunde> ; \002%botnick% egg floodmenuprot\002 <nr comenzi:secunde> ; \002(PRIVMSG) egg floodmenuprot\002 <nr comenzi:secunde>"
...
set black(say.ro.man.1125) "\[MAN\] \002%char%egg floodmsgprot\002 <nr mesaje:secunde> ; \002%botnick% egg floodmsgprot\002 <nr mesaje:secunde> ; \002(PRIVMSG) egg floodmsgprot\002 <nr mesaje:secunde>"
...
set black(say.ro.man.1129) "\[MAN\] \002%char%egg floodnotcprot\002 <nr notice:secunde> ; \002%botnick% egg floodnotcprot\002 <nr notice:secunde> ; \002(PRIVMSG) egg floodnotcprot\002 <nr notice:secunde>"
...
set black(say.ro.man.1133) "\[MAN\] \002%char%egg chanremove-setting\002 <1/0> ; \002%botnick% egg chanremove-setting\002 <1/0> ; \002(PRIVMSG) egg chanremove-setting\002 <1/0>"
...
set black(say.ro.man.1137) "\[MAN\] \002%char%egg user-expire\002 <zile> ; \002%botnick% egg user-expire\002 <zile> ; \002(PRIVMSG) egg user-expire\002 <zile>"
...
set black(say.ro.man.1141) "\[MAN\] \002%char%egg pagelimit\002 <nr intrari> ; \002%botnick% egg pagelimit\002 <nr intrari> ; \002(PRIVMSG) egg pagelimit\002 <nr intrari>"
...
set black(say.ro.man.1145) "\[MAN\] \002%char%egg login\002 ; %botnick% egg login ; \002(PRIVMSG) egg login\002"
...
set black(say.ro.man.1149) "\[MAN\] \002%char%egg chanserv\002 <nickchanserv> ; \002\002%botnick% egg chanserv\002 <nickchanserv> ; \002(PRIVMSG) egg chanserv\002 <nickchanserv>"
...
set black(say.ro.man.1153) "\[MAN\] \002%char%egg hostchanserv\002 <hostchanserv> ; \002%botnick% egg hostchanserv\002 <hostchanserv> ; \002(PRIVMSG) egg hostchanserv\002 <hostchanserv>"
...
set black(say.ro.man.1157) "\[MAN\] \002%char%egg userlogin\002 <userchanserv> ; \002%botnick% egg userlogin\002 <userchanserv> ; \002(PRIVMSG) egg userlogin\002 <userchanserv>"
...
set black(say.ro.man.1161) "\[MAN\] \002%char%egg userpass\002 <passchanserv> ; \002%botnick% egg userpass\002 <passchanserv> ; \002(PRIVMSG) egg userpass\002 <passchanserv>"

#Egg Add-Mask

set black(say.ro.man.1163) "\[MAN\] \002Add-Mask\002 este o comanda prin care puteti seta host-ul default pe care eggdrop-ul va il va folosi la adaugarea de noi useri cu acces (pentru adaugare dupa username)."
set black(say.ro.man.1164) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.1165) "\[MAN\] \002%char%egg add-mask\002 <hostmask> ; \002%botnick% egg add-mask\002 <hostmask> ; \002(PRIVMSG) egg add-mask\002 <hostmask>"

#Egg Adduser-Mask

set black(say.ro.man.1167) "\[MAN\] \002Adduser-Mask\002 este o comanda prin care puteti seta host-ul default pe care eggdrop-ul va il va folosi la adaugarea de noi useri cu acces (pentru adaugare dupa nick)."
set black(say.ro.man.1168) "\[MAN\] SINTAXA FOLOSIRE:"
set black(say.ro.man.1169) "\[MAN\] \002%char%egg adduser-mask\002 <hostmask> ; \002%botnick% egg adduser-mask\002 <hostmask> ; \002(PRIVMSG) egg adduser-mask\002 <hostmask>"

#AntiSpam-CycleTime

set black(say.ro.man.1175) "\[MAN\] \002AntiSpam-CycleTime\002 este o extra optiune a modulului \002antispam\002 prin care puteti defini perioada maxima de timp dintre fiecare\002 /cycle\002 pe care eggdrop-ul il executa pentru a detecta mesajele de spam."
...
set black(say.ro.man.1177) "\[MAN\] \002%char%egg\002 antispam-cycletime <perioada> ; \002%botnick% egg\002 antispam-cycletime <perioada> ; \002(PRIVMSG) egg\002 antispam-cycletime <perioada>"
...
set black(say.ro.man.1181) "\[MAN\] \002%char%egg\002 idle-scantime <perioada> ; \002%botnick% egg\002 idle-scantime <perioada> ; \002(PRIVMSG) egg\002 idle-scantime <perioada>"
...
set black(say.ro.man.1185) "\[MAN\] \002%char%egg\002 clonescan-scantime <perioada> ; \002%botnick% egg\002 clonescan-scantime <perioada> ; \002(PRIVMSG) egg\002 clonescan-scantime <perioada>"
...
set black(say.ro.man.1193) "\[MAN\] \002%char%egg\002 badchan-scantime <perioada> ; \002%botnick% egg\002 badchan-scantime <perioada> ; \002(PRIVMSG) egg\002 badchan-scantime <perioada>"
...
set black(say.ro.man.1197) "\[MAN\] \002%char%egg\002 anunt-showtime <perioada> ; \002%botnick% egg\002 anunt-showtime <perioada> ; \002(PRIVMSG) egg\002 anunt-showtime <perioada>"
...
set black(say.ro.man.1201) "\[MAN\] \002%char%egg\002 quoteofday-showtime <perioada> ; \002%botnick% egg\002 quoteofday-showtime <perioada> ; \002(PRIVMSG) egg\002 quoteofday-showtime <perioada>"
...
set black(say.ro.man.1206) "\[MAN\] \002Retineti:\002 Aceasta extra optiune va functiona DOAR daca modulul \002AntiBadQuitPart\002 este activat."
...
set black(say.ro.man.2103) "\[MAN\] \002%char%set\002 ban-time <timp> ; \002%botnick% set\002 ban-time <timp> ; \002(PRIVMSG) set\002 <#canal> ban-time <timp>"
